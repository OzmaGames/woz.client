...
define('plugins/router',["durandal/system","durandal/app","durandal/activator","durandal/events","durandal/composition","plugins/history","knockout","jquery"],function(e,t,n,o,i,a,r,s){function l(e){return e=e.replace(m,"\\$&").replace(f,"(?:$1)?").replace(g,function(e,t){return t?e:"([^/]+)"}).replace(v,"(.*?)"),new RegExp("^"+e+"$")}function c(e){var t=e.indexOf(":"),n=t>0?t-1:e.length;return e.substring(0,n)}function u(e,t){return-1!==e.indexOf(t,e.length-t.length)}function d(e,t){if(!e||!t)return!1;if(e.length!=t.length)return!1;for(var n=0,o=e.length;o>n;n++)if(e[n]!=t[n])return!1;return!0}var p,h,f=/\((.*?)\)/g,g=/(\(\?)?:\w+/g,v=/\*\w+/g,m=/[\-{}\[\]+?.,\\\^$|#\s]/g,y=/\/$/,b=function(){function i(e){return e.router&&e.router.parent==$}function s(e){P&&P.config.isActive&&P.config.isActive(e)}function f(t,n){e.log("Navigation Complete",t,n);var o=e.getModuleId(A);o&&$.trigger("router:navigation:from:"+o),A=t,s(!1),P=n,s(!0);var a=e.getModuleId(A);a&&$.trigger("router:navigation:to:"+a),i(t)||$.updateDocumentTitle(t,n),h.explicitNavigation=!1,h.navigatingBack=!1,$.trigger("router:navigation:complete",t,n,$)}function g(t,n){e.log("Navigation Cancelled"),$.activeInstruction(P),P&&$.navigate(P.fragment,!1),E(!1),h.explicitNavigation=!1,h.navigatingBack=!1,$.trigger("router:navigation:cancelled",t,n,$)}function v(t){e.log("Navigation Redirecting"),E(!1),h.explicitNavigation=!1,h.navigatingBack=!1,$.navigate(t,{trigger:!0,replace:!0})}function m(t,n,o){h.navigatingBack=!h.explicitNavigation&&A!=o.fragment,$.trigger("router:route:activating",n,o,$),t.activateItem(n,o.params).then(function(e){if(e){var a=A;if(f(n,o),i(n)){var r=o.fragment;o.queryString&&(r+="?"+o.queryString),n.router.loadUrl(r)}a==n&&($.attached(),$.compositionComplete())}else t.settings.lifecycleData&&t.settings.lifecycleData.redirect?v(t.settings.lifecycleData.redirect):g(n,o);p&&(p.resolve(),p=null)}).fail(function(t){e.error(t)})}function w(t,n,o){var i=$.guardRoute(n,o);i?i.then?i.then(function(i){i?e.isString(i)?v(i):m(t,n,o):g(n,o)}):e.isString(i)?v(i):m(t,n,o):g(n,o)}function x(e,t,n){$.guardRoute?w(e,t,n):m(e,t,n)}function k(e){return P&&P.config.moduleId==e.config.moduleId&&A&&(A.canReuseForRoute&&A.canReuseForRoute.apply(A,e.params)||!A.canReuseForRoute&&A.router&&A.router.loadUrl)}function T(){if(!E()){var t=M.shift();M=[],t&&(E(!0),$.activeInstruction(t),k(t)?x(n.create(),A,t):e.acquire(t.config.moduleId).then(function(n){var o=e.resolveObject(n);x(D,o,t)}).fail(function(n){e.error("Failed to load routed module ("+t.config.moduleId+"). Details: "+n.message)}))}}function _(e){M.unshift(e),T()}function C(e,t,n){for(var o=e.exec(t).slice(1),i=0;i<o.length;i++){var a=o[i];o[i]=a?decodeURIComponent(a):null}var r=$.parseQueryString(n);return r&&o.push(r),{params:o,queryParams:r}}function S(t){$.trigger("router:route:before-config",t,$),e.isRegExp(t)?t.routePattern=t.route:(t.title=t.title||$.convertRouteToTitle(t.route),t.moduleId=t.moduleId||$.convertRouteToModuleId(t.route),t.hash=t.hash||$.convertRouteToHash(t.route),t.routePattern=l(t.route)),t.isActive=t.isActive||r.observable(!1),$.trigger("router:route:after-config",t,$),$.routes.push(t),$.route(t.routePattern,function(e,n){var o=C(t.routePattern,e,n);_({fragment:e,queryString:n,config:t,params:o.params,queryParams:o.queryParams})})}function I(t){if(e.isArray(t.route))for(var n=t.isActive||r.observable(!1),o=0,i=t.route.length;i>o;o++){var a=e.extend({},t);a.route=t.route[o],a.isActive=n,o>0&&delete a.nav,S(a)}else S(t);return $}var A,P,M=[],E=r.observable(!1),D=n.create(),$={handlers:[],routes:[],navigationModel:r.observableArray([]),activeItem:D,isNavigating:r.computed(function(){var e=D(),t=E(),n=e&&e.router&&e.router!=$&&e.router.isNavigating()?!0:!1;return t||n}),activeInstruction:r.observable(null),__router__:!0};return o.includeIn($),D.settings.areSameItem=function(e,t,n,o){return e==t?d(n,o):!1},$.parseQueryString=function(e){var t,n;if(!e)return null;if(n=e.split("&"),0==n.length)return null;t={};for(var o=0;o<n.length;o++){var i=n[o];if(""!==i){var a=i.split("=");t[a[0]]=a[1]&&decodeURIComponent(a[1].replace(/\+/g," "))}}return t},$.route=function(e,t){$.handlers.push({routePattern:e,callback:t})},$.loadUrl=function(t){var n=$.handlers,o=null,i=t,r=t.indexOf("?");if(-1!=r&&(i=t.substring(0,r),o=t.substr(r+1)),$.relativeToParentRouter){var s=this.parent.activeInstruction();i=s.params.join("/"),i&&"/"==i.charAt(0)&&(i=i.substr(1)),i||(i=""),i=i.replace("//","/").replace("//","/")}i=i.replace(y,"");for(var l=0;l<n.length;l++){var c=n[l];if(c.routePattern.test(i))return c.callback(i,o),!0}return e.log("Route Not Found"),$.trigger("router:route:not-found",t,$),P&&a.navigate(P.fragment,{trigger:!1,replace:!0}),h.explicitNavigation=!1,h.navigatingBack=!1,!1},$.updateDocumentTitle=function(e,n){n.config.title?document.title=t.title?n.config.title+" | "+t.title:n.config.title:t.title&&(document.title=t.title)},$.navigate=function(e,t){return e&&-1!=e.indexOf("://")?(window.location.href=e,!0):(h.explicitNavigation=!0,a.navigate(e,t))},$.navigateBack=function(){a.navigateBack()},$.attached=function(){$.trigger("router:navigation:attached",A,P,$)},$.compositionComplete=function(){E(!1),$.trigger("router:navigation:composition-complete",A,P,$),T()},$.convertRouteToHash=function(e){if($.relativeToParentRouter){var t=$.parent.activeInstruction(),n=t.config.hash+"/"+e;return a._hasPushState&&(n="/"+n),n=n.replace("//","/").replace("//","/")}return a._hasPushState?e:"#"+e},$.convertRouteToModuleId=function(e){return c(e)},$.convertRouteToTitle=function(e){var t=c(e);return t.substring(0,1).toUpperCase()+t.substring(1)},$.map=function(t,n){if(e.isArray(t)){for(var o=0;o<t.length;o++)$.map(t[o]);return $}return e.isString(t)||e.isRegExp(t)?(n?e.isString(n)&&(n={moduleId:n}):n={},n.route=t):n=t,I(n)},$.buildNavigationModel=function(t){for(var n=[],o=$.routes,i=t||100,a=0;a<o.length;a++){var r=o[a];r.nav&&(e.isNumber(r.nav)||(r.nav=++i),n.push(r))}return n.sort(function(e,t){return e.nav-t.nav}),$.navigationModel(n),$},$.mapUnknownRoutes=function(t,n){var o="*catchall",i=l(o);return $.route(i,function(r,s){var l=C(i,r,s),c={fragment:r,queryString:s,config:{route:o,routePattern:i},params:l.params,queryParams:l.queryParams};if(t)if(e.isString(t))c.config.moduleId=t,n&&a.navigate(n,{trigger:!1,replace:!0});else if(e.isFunction(t)){var u=t(c);if(u&&u.then)return u.then(function(){$.trigger("router:route:before-config",c.config,$),$.trigger("router:route:after-config",c.config,$),_(c)}),void 0}else c.config=t,c.config.route=o,c.config.routePattern=i;else c.config.moduleId=r;$.trigger("router:route:before-config",c.config,$),$.trigger("router:route:after-config",c.config,$),_(c)}),$},$.reset=function(){return P=A=void 0,$.handlers=[],$.routes=[],$.off(),delete $.options,$},$.makeRelative=function(t){return e.isString(t)&&(t={moduleId:t,route:t}),t.moduleId&&!u(t.moduleId,"/")&&(t.moduleId+="/"),t.route&&!u(t.route,"/")&&(t.route+="/"),t.fromParent&&($.relativeToParentRouter=!0),$.on("router:route:before-config").then(function(e){t.moduleId&&(e.moduleId=t.moduleId+e.moduleId),t.route&&(e.route=""===e.route?t.route.substring(0,t.route.length-1):t.route+e.route)}),$},$.createChildRouter=function(){var e=b();return e.parent=$,e},$};return h=b(),h.explicitNavigation=!1,h.navigatingBack=!1,h.targetIsThisWindow=function(e){var t=s(e.target).attr("target");return!t||t===window.name||"_self"===t||"top"===t&&window===window.top?!0:!1},h.activate=function(t){return e.defer(function(n){if(p=n,h.options=e.extend({routeHandler:h.loadUrl},h.options,t),a.activate(h.options),a._hasPushState)for(var o=h.routes,i=o.length;i--;){var r=o[i];r.hash=r.hash.replace("#","")}s(document).delegate("a","click",function(e){if(a._hasPushState){if(!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey&&h.targetIsThisWindow(e)){var t=s(this).attr("href");null==t||"#"===t.charAt(0)||/^[a-z]+:/i.test(t)||(h.explicitNavigation=!0,e.preventDefault(),a.navigate(t))}}else h.explicitNavigation=!0}),a.options.silent&&p&&(p.resolve(),p=null)}).promise()},h.deactivate=function(){a.deactivate()},h.install=function(){r.bindingHandlers.router={init:function(){return{controlsDescendantBindings:!0}},update:function(e,t,n,o,a){var s=r.utils.unwrapObservable(t())||{};if(s.__router__)s={model:s.activeItem(),attached:s.attached,compositionComplete:s.compositionComplete,activate:!1};else{var l=r.utils.unwrapObservable(s.router||o.router)||h;s.model=l.activeItem(),s.attached=l.attached,s.compositionComplete=l.compositionComplete,s.activate=!1}i.compose(e,s,a)}},r.virtualElements.allowedBindings.router=!0},h});
...
(function ($) {
   ...
   function simulateMouseEvent(event, simulatedType) {
      ...
      if (event.currentTarget.onlyClick) {
         if (simulatedType != 'click') return;
      }
...
define("common",["durandal/system","durandal/app","plugins/router","dialogs/_builder","api/server/setup","api/datacontext","./palette","../lib/jquery.transit","../lib/jquery.touch-punch","../lib/crypto.sha3","api/knockout"],function(e,t,n,o,r,a,i){function s(){var e=document.getElementById("shell");t.browser.tablet&&!t.browser.iPad&&(e=d),$(e).delay(1).promise().then(function(){$(e).css({y:0,transition:"all .5s ease-in-out"}).delay(500).promise().then(function(){$(e).css({transition:"none",transform:"none"}),$("#app, body").trigger("scroll")})})}var l=null,u=100,d=document.getElementById("app");t.browser={},t.browser.iPad=navigator.userAgent.match(/iPad/i),t.browser.kindle=navigator.vendor.match(/amazon\.com/i),t.browser.android=navigator.userAgent.match(/android/i)||t.browser.kindle,t.browser.tablet=t.browser.iPad||t.browser.kindle||t.browser.android,t.browser.android&&(d=document.body),t.el=d,window.addEventListener("resize",function(e){t.trigger("app:resized:hook",event),setTimeout(function(){t.trigger("app:resized:instant",event)},0),clearTimeout(l),l=setTimeout(function(e){t.trigger("app:resized",e)},u,e)},!1);var c=ko.observable(!1);t.inlineLoading=ko.observable(!1),t.loading=ko.computed({read:function(){return c()||a.loading()===!0},write:function(e){c(e)},owner:this}),t.scrollUp=function(){console.log("Scrolling UP");var e=document.getElementById("shell");t.browser.android&&(e=d),0!=d.scrollTop&&($(e).css({y:-d.scrollTop}),d.scrollTop=0,s())},t.scrollDown=function(e){console.log("Scrolling Down");var n=document.getElementById("shell");t.browser.android&&(n=d);var o=d.scrollHeight-d.clientHeight;if($("#gameboard").length){var r=$("#gameboard").outerHeight()-100;o>r&&(o=r)}e=e||o-d.scrollTop,0!=e&&(t.browser.android?$(d).animate({scrollTop:e+d.scrollTop},"slow","swing"):($(n).css({y:e}),d.scrollTop=e+d.scrollTop,s()))},t.navigate=function(e,t){n.navigate(e,t)},t.dialog=o,t.palette=i,t.palette.get("menu").click(function(){t.dialog.show("menu")}),t.palette.fixedItemsCount=t.browser.tablet?2:3,t.console={log:function(e){$("#console").html(e)}};var g=!1;t.on("app:fullscreen").then(function(){var e=$("html")[0];g?e.webkitCancelFullscreen():e.webkitRequestFullscreen?e.webkitRequestFullscreen():e.webkitEnterFullScreen&&e.webkitEnterFullscreen()}),alert("user agent: "+navigator.userAgent+"\nplatform: "+navigator.platform+"\nappName: "+navigator.appName+"\nappVersion: "+navigator.appVersion+"\nvendor: "+navigator.vendor+"\nvendorSub: "+navigator.vendorSub+"\nproduct: "+navigator.product)});
define('text!dialogs/pages/GameOver.html',[],function () { return '<i class="command close"></i>\r\n\r\n<h1 data-bind="text: heading"></h1>\r\n<div data-bind="text: content"></div>\r\n<br />\r\n<div class="strong">You received:</div>\r\n<div>\r\n   5 XP\r\n</div>\r\n<br />\r\n<button class="blue" data-bind="text: btnText, click: gotoLobby, clickBubble: false"></button>';});
...
define('dialogs/templates/alert',["durandal/app"],function(){function e(){this.content="",this.attributes={fixed:!0,singleton:!0}}var t=2e3,n=500;return e.prototype.activate=function(e){this.content=e.content,t=e.delay||t},e.prototype.attached=function(e){this.el=$(".alert",e),this.el.css({top:($(window).innerHeight()-this.el.outerHeight())/2}),this.el.css({y:-100,display:"block",opacity:0}).transition({y:20,opacity:.8},n,"ease").transition({y:0,opacity:1},n/2,"ease").delay(t).fadeOut()},e.prototype.canDeactivate=function(){var e=this;return $.Deferred(function(t){e.el?e.el.promise().then(function(){t.resolve()}):t.resolve()}).promise()},e});
define('text!dialogs/templates/confirm.html',[],function () { return '<div class="dialog bottom-center">\r\n    <div class="ui-overlay"></div>\r\n    <div class="confirm">\r\n        <p data-bind="html:content, visible:content"></p>\r\n        <button class="flat orange" data-bind="click: cancel, text:cancelText">CANCEL</button>\r\n        <button class="flat blue" data-bind="click: done, text: doneText" autofocus>DONE</button>\r\n    </div>\r\n</div>\r\n';});

define('dialogs/templates/confirm',["durandal/app"],function(){function e(){this.content="",this.cancelText="CANCEL",this.doneText="DONE",this.duration=400,this.modal=!1,this.images=!0;var e=this;this.done=function(){e.close("done")},this.cancel=function(){e.close("cancel")},this.close=function(t){e.el.transition({y:0},300).transition({y:100,opacity:0}).promise().then(function(){e.el.hide().css({opacity:""})}),e.el.parent().removeClass("modal"),e.onClose(t)},this.onClose=function(){}}return e.prototype.activate=function(e){e&&(this.modal=e.modal||this.modal,this.duration=e.duration||this.duration,this.content=e.content||this.content,this.doneText=e.doneText||this.doneText,this.cancelText=e.cancelText||this.cancelText)},e.prototype.bindingComplete=function(e){this.el=$(".confirm",e).css({opacity:0}),this.modal&&this.el.parent().addClass("modal"),this.__dialog__.settings.bindingComplete(e)},e.prototype.load=function(){var e=this;e.el.css({y:100,opacity:0}).transition({y:0,opacity:1},300,"ease").transition({y:10},200)},e.prototype.canDeactivate=function(){var e=this;return $.Deferred(function(t){e.el&&e.el.promise().then(function(){t.resolve(!0)})}).promise()},e});
...
define('dialogs/templates/loading',["durandal/app","api/datacontext"],function(e,t){function n(){this.loadingStatus=t.loadingStatus,this.loading=t.loading,this.duration=400}return n.prototype.activate=function(){},n.prototype.binding=function(e){this.el=$(".loading",e)},n.prototype.bindingComplete=function(){},n.prototype.compositionComplete=function(t){this.el=$(".loading",t),e.inlineLoading(!0),this.el.css({top:($(window).innerHeight()-this.el.outerHeight())/2}),this.el.css({y:-100,display:"block",opacity:0}).transition({y:20,opacity:.8},this.duration,"ease").transition({y:0,opacity:1},this.duration/2,"ease")},n.prototype.canDeactivate=function(){var t=this;return $.Deferred(function(n){e.inlineLoading(!1),t.el?t.el.promise().then(function(){n.resolve(!0)}):n.resolve(!0)}).promise()},n});
...
define('dialogs/templates/panel',["durandal/app"],function(e){function t(){if(n){var t=e.el.clientHeight,o=(t-n.outerHeight())/2;n.transition({top:o})}}var n,o;return{activate:function(n){n&&(this.modelName(n),o=e.on("app:resized:instant").then(t))},bindingComplete:function(e){return $(".panel",e).hide(),{cacheViews:!1}},compositionComplete:function(t){n=this.el=$(".panel",t);var o=e.el.clientHeight,i=(o-n.outerHeight())/2;n.css({y:i}).show(),n.css({y:i-100,opacity:0}).transition({y:i+10,opacity:1}).transition({y:i}).promise().then(function(){n.css({y:0,top:i})})},canDeactivate:function(){return o.off(),this.el.fadeOut("fast").promise()},modelName:ko.observable(),loading:e.loading,attributes:{fixed:!1,singleton:!0}}});
...
define('text!dialogs/templates/window.html',[],function () { return '<div class="dialog absolute low top-left">\r\n   <div class="window">\r\n      <div style="position:absolute; top:0; right:0; width:32px; height: 32px;" data-bind="click: close">\r\n         <i class="command close"></i>\r\n      </div>\r\n      <h1 data-bind="text: heading"></h1>\r\n      <div data-bind="html: content"></div>\r\n   </div>\r\n</div>\r\n';});

define('dialogs/templates/window',["durandal/app","api/draggable"],function(){function e(){this.heading="",this.content="";var e=this;this.close=function(){return this.draggable&&e.el.data("draggable").dispose(),e.el.animate({height:0,opacity:0},250).promise().then(function(){$(this).hide()})},this.onClose=function(){}}return e.prototype.activate=function(e){this.heading=e.heading,this.content=e.content,this.left=e.left||0,this.top=e.top||0,this.draggable=void 0===e.draggable?!0:e.draggable;var t=$(window).innerWidth();t-this.left<300&&(this.left=t-350)},e.prototype.attached=function(e){this.el=$(".window",e),this.left=($(window).innerWidth()-this.el.outerWidth())/2,this.top+=document.getElementById("app").scrollTop,this.el.css({x:100,opacity:0,top:this.top,left:this.left}).transition({x:-10,opacity:1},500,"ease").transition({x:0},300).promise().then(function(){this.css({x:0})}),this.draggable&&this.el.draggable({usePercentage:!1,topLimit:!0,withinEl:$("#app")})},e.prototype.canDeactivate=function(){return this.close(200)},e});
...
define('game/canvas/vm/Box',["durandal/app","api/datacontext","paper"],function(e){function t(e,t,n,o){var a=this;a.index=e,a.active=!1,a.cPoint=n||i,a.angle=o||0,a.prevAngle=0,a.scale=1,a.prevScale=1,a.isCircle=!1,a.isButton=!1,a._guiRect=null,a._guiElem=null,a.pathModel=a.wordModel=a.hasData=null,this.updateModel(t)}var n=paper,o=new n.Color(0,0),i=new n.Point(-100,-100);return t.prototype.button=function(e){this.hasData=!0,this.isButton=!0,this.isCircle=!1,this.pathModel=e},t.prototype.hideIfEmpty=function(){!this.hasData&&this._guiRect&&this._guiRect.hide()},t.prototype.showIfEmpty=function(){!this.hasData&&this._guiRect&&this._guiRect.show()},t.prototype.updateModel=function(e){if(void 0!==e&&null!=e&&(this.pathModel=e,this.wordModel=e.getWordAt(this.index),this.hasData=null!=this.wordModel,this.isCircle=0==e.nWords,this.hasData)){if(!this.pathModel.canvas.cPoint)return;this.show()}},t.prototype.show=function(){this.hasData?(this.active=!1,null!=this._guiRect&&(this._guiRect.remove(),this._guiRect=null),this.isButton?null==this._guiElem?this.createBtn():this.updateBtn():(this.prevAngle=0,null==this._guiElem?this.createElem():this.updateElem())):(null!=this._guiElem&&(this._guiElem.remove(),this._guiElem=null),null==this._guiRect?this.createRect():this.updateRect())},t.prototype.width=function(){return this.hasData?this._guiElem?this._guiElem.outerWidth():62:this.isCircle?t.options.circle.radius:62},t.prototype.enter=function(e){return this.hasData||null==e?null:(this.wordModel=e,this.active=!0,clearInterval(this._hoverHandler),this._hoverHandler=setTimeout(function(e){e._guiRect&&e._guiRect.addClass("hover")},1,this),this)},t.prototype.leave=function(){!this.hasData&&this.active&&(this.active=!1,clearInterval(this._hoverHandler),this._hoverHandler=setTimeout(function(e){e._guiRect.removeClass("hover"),e.isCircle||e._guiRect.children(".box").text("")},1,this))},t.prototype.drop=function(){this.active&&!this.hasData&&null!=this.wordModel&&(this.pathModel.addWord(this.wordModel,this.index)||e.dialog.show("alert",{content:"It's not your turn!"}))},t.prototype.put=function(e){if(!this.hasData&&null!=e.obsWords()){var t=this.pathModel.nWords,n=e.obsWords();if(n.length==t)for(var o=0;o<n.length;o++)this.pathModel.addWord(n[o],o+1)}},t.prototype.updateBtn=function(){var e={x:this.cPoint.x-t.pathOptions.container.left-this._guiElem.outerWidth()/2,y:this.cPoint.y-t.pathOptions.container.top-this._guiElem.outerHeight()/2},n=this._guiElem.find(".button");this.scale*=.5;var o=this._guiElem;o.css(e),n.transition({scale:this.scale,rotate:this.angle},500,"ease").promise().then(function(){o.addClass("ready")})},t.prototype.createBtn=function(){var e=$("<div/>",{"class":"confirm-box"}),n=this,o=this.pathModel.cw?" cw":"";e.append($("<div/>",{"class":"button",title:"Done!"}).append($("<div/>",{"class":"tooltip"+o,text:"Click me when you are done!"}).delay(4e3).fadeOut(1e3))),e.css({x:this.pathModel.canvas.cPoint.x-t.pathOptions.container.left,y:this.pathModel.canvas.cPoint.y-t.pathOptions.container.top}),e.appendTo("#tiles"),e.find(".button").one("click",this,function(){t.options.animate=!0,n.pathModel.phrase._complete(!0),n.pathModel.phrase.words.valueHasMutated(),t.options.animate=!1}).transition({rotateY:"360deg"},500,"ease"),this.width=function(){return e.outerWidth()/2},null!=this._guiElem&&this._guiElem.remove(),this._guiElem=e,this.updateBtn()},t.prototype.updateElem=function(){this.pathModel.phrase.complete()&&(this._guiElem.find(".magnet").addClass("placed"),this._guiElem.off("click")),this._guiElem.find(".magnet").text(this.wordModel.lemma);var e={x:this.cPoint.x-t.pathOptions.container.left-this._guiElem.outerWidth()/2,y:this.cPoint.y-t.pathOptions.container.top-this._guiElem.outerHeight()/2,rotate:this.angle+"deg"};e.scale=.8*this.scale,this._guiElem.stop(),this._guiElem.transition(e,500,"ease")},t.prototype.createElem=function(){var e=$("<div/>",{"class":"magnet-placeholder elem"}),n=$("<div/>",{"class":"magnet",text:this.wordModel.lemma});e.append(n),this.wordModel.isRelated&&n.addClass("related"),e.css({x:this.pathModel.canvas.cPoint.x-t.pathOptions.container.left,y:this.pathModel.canvas.cPoint.y-t.pathOptions.container.top,zIndex:2,scale:.8}),e.appendTo("#tiles"),e.one("click",this,function(e){e.data.pathModel.phrase.complete()||e.data.pathModel.removeWordAt(e.data.index)}),null!=this._guiElem&&this._guiElem.remove(),this._guiElem=e,this.updateElem()},t.prototype.updateRect=function(){this._guiRect.css({x:this.cPoint.x-t.pathOptions.container.left-this._guiRect.outerWidth()/2,y:this.cPoint.y-t.pathOptions.container.top-this._guiRect.outerHeight()/2,rotate:this.angle,scale:this.scale})},t.prototype.createRect=function(){var e=$("<div/>",{"class":"magnet-placeholder"}),n=this.isCircle?"circle":"box";e.append($("<div/>",{"class":n})),e.css({x:this.pathModel.canvas.cPoint.x-t.pathOptions.container.left,y:this.pathModel.canvas.cPoint.y-t.pathOptions.container.top,zIndex:0}),e.appendTo("#tiles"),this._guiRect=e,this.updateRect()},t.prototype._clear=function(){this._guiRect&&this._guiRect.remove(),this._guiElem&&this._guiElem.remove(),this._guiElem=null,this._guiRect=null},t.prototype.remove=function(){this._clear()},t.options={animate:!1,rect:{style:{strokeColor:"#CBB28F",strokeWidth:1,fillColor:o,shadowColor:o},activeStyle:{strokeWidth:2,shadowColor:"#CBB28F",shadowBlur:5,shadowOffset:new n.Point(0,0)},size:new n.Point(30,15)},circle:{radius:8,margin:16,width:23,style:{fillColor:"#CBB28F",shadowBlur:0,strokeWidth:0},activeStyle:{strokeWidth:2,strokeColor:"#CBB28F",shadowBlur:20,shadowColor:"#CBB28F",shadowOffset:new n.Point(0,0)}},textStyle:{fillColor:"grey",justification:"center",fontSize:14,font:"CopseRegular"}},t});
define('game/canvas/vm/Path',["durandal/app","api/datacontext","game/canvas/vm/Box","paper"],function(e,t,n){function o(e){this._displayItems=[],this._trash=[],this.pathModel=e}var i=t.activeWord,a=t.activeWords,r=new paper.Color(0,0),s=null;return i.subscribe(function(e){null==e&&null!=s&&s.drop()}),o.activePath=null,o.prototype.isActive=!1,o.prototype.leavingHandler=0,o.prototype.enter=function(){var e=null!=a(),t=this.pathModel;if(e){var n=a();if(n.length!=t.nWords)return;for(var i=0;i<t.guiBoxes.length;i++)t.guiBoxes[i].enter(n[i])}else t&&t.onEnter&&(this.isActive||(o.activePath&&o.activePath!=this&&(o.activePath.isActive=!1),this.isActive=!0,o.activePath=this,t.onEnter(this.midPath)),this.leavingHandler&&(clearTimeout(this.leavingHandler),this.leavingHandler=0))},o.prototype.leave=function(){var e=this.pathModel;if(null!=a()){var t=a();if(t.length!=e.nWords)return;for(var n=0;n<e.guiBoxes.length;n++)e.guiBoxes[n].leave()}else e&&e.onLeave&&(this.leavingHandler&&clearTimeout(this.leavingHandler),this.leavingHandler=setTimeout(function(t){t.isActive&&(t.isActive=!1,e.onLeave(),o.activePath==t&&(o.activePath=null))},1,this))},o.prototype.put=function(){if(null!=a()){var t=a(),n=this.pathModel;if(a(null),t.length!=n.nWords)return t.length>n.nWords?e.dialog.show("alert",{content:"too many words"}):e.dialog.show("alert",{content:"need more words"}),a(t),void 0;for(var o=0;o<n.guiBoxes.length;o++)n.addWord(t[o],o)}},o.prototype.events={boxHoverEvents:{mouseenter:function(e){s=this.data.enter(i()),this.data.pathModel.canvas.enter(e)},mouseleave:function(){this.data.leave(),this.data.pathModel.canvas&&this.data.pathModel.canvas.leave()},mousedown:function(){this.data.pathModel.canvas.put()}}},o.prototype.dispose=function(){this.remove(),this._removeAll(this.pathModel.guiBoxes),delete this.pathModel.guiBoxes},o.prototype.setup=function(){console.log("%cPath Setup","background: orange; color: white",this.pathModel.id);var e=this.pathModel,t=e.nWords;if(0==e.nWords&&(t=6),e.guiBoxes&&e.guiBoxes.length==t)for(var o=0;t>o;o++){var i=e.guiBoxes[o];i.updateModel(e)}else if(e.guiBoxes)if(e.guiBoxes.length>t)e.guiBoxes[t].remove(),e.removeWordAt(t),e.guiBoxes.splice(t,1);else{var i=new n(t-1,e);e.guiBoxes.push(i),this._displayItems.push(i)}else{e.guiBoxes=[];for(var o=0;t>o;o++){var i=new n(o,e);e.guiBoxes.push(i),this._displayItems.push(i)}}},o.prototype.show=function(){console.log("%cPath","background: orange; color: white",this.pathModel.id+" is being drawn");var e=this.pathModel,t=e.nWords;if(null!=e.guiBoxes){this._cleanCycle();var n=o.getDesiredLength(e.guiBoxes);path=o.getBestArc(e.startTile.center,e.endTile.center,n,e.cw,t),this.cPoint=o.cPoint,this.midPath=path.getPointAt(path.length/2);for(var i=path.length-n,a=(path.length-2*(o.options.tileMargin+o.options.tileRadius),o.options.tileRadius+o.options.tileMargin),r=a,s=0;t>s;s++){var l=e.guiBoxes[s],d=l.width()/2+o.options.rectMargin+i/(2*t);r+=d;var c=path.getPointAt(r),u=path.getTangentAt(r),p=this.createHoverArea(path,r,l.width()+2*o.options.rectMargin+i/t);p.data=l,r+=d,l.cPoint=c,l.angle=u.angle,l.scale=i>=0?1:path.length/n,l.show(),o.options.debug&&(p.strokeColor="lightgreen")}if(o.options.debug){this._trash.push(path);for(var s=0;s<o._trash.length;s++)this._trash.push(o._trash[s]);o._trash=[]}else path.remove();paper.view.draw()}},o.prototype.createHoverArea=function(e,t,n){var i=t-n/2,a=e.getPointAt(i),s=e.getNormalAt(i).normalize(o.options.hoverMargin),l=t+n/2,d=e.getPointAt(l),c=e.getNormalAt(l).normalize(o.options.hoverMargin),u=new paper.Path(a.add(s),a.subtract(s),d.subtract(c),d.add(c));return u.closePath(),u.fillColor=r,u.on(this.events.boxHoverEvents),this._trash.push(u),u},o.prototype._cleanCycle=function(){this._removeAll(this._trash),this._trash=[],o.options.debug&&o._clear()},o.prototype._removeAll=function(e){if(null!=e)for(var t=0;t<e.length;t++)e[t].remove()},o.prototype.remove=function(){this._removeAll(this._trash),this._removeAll(this._displayItems),this._displayItems=[],this._trash=[]},o._trash=[],o.getBestArc=function(e,t,n,i,a,r){var s=t.subtract(e).length,l=o.options.minArc*(a/2),d=o.options.maxArc*(a/3),c=new paper.Path.Line(e,t),u=c.getPointAt(c.length/2),p=c.getNormalAt(c.length/2);c.remove(),o.cPoint=u,s>550&&(d*=550/s,l=o.options.minArc*(a/4)),d>150&&(d=150),d=30*a,l=d-40,c=new paper.Path.Line(u.subtract(p.normalize(-l*(i?1:-1))),u.subtract(p.normalize(-d*(i?1:-1))));var h,g=0,f=c.length,v=1e4,m=c.length/2;r=r||10;for(var b=0;r>b;b++,m/=2){var y=c.getPointAt((g+f)/2),w=new paper.Path.Arc(e,y,t);Math.abs(w.length-n)<v?(h&&h.remove(),v=Math.abs(w.length-n),h=w):w.remove(),w.length>n?f-=m:g+=m}if(o.options.debug){var x=new paper.Path.Circle(u,5);x.fillColor="orange",c.strokeColor="orange",c.strokeWidth=2,h.strokeColor="grey",o._trash.push(x),o._trash.push(c)}else c.remove();return h},o.getDesiredLength=function(e,t){for(var n=2*(o.options.tileMargin+o.options.tileRadius),i=0;i<(t||e.length);i++)n+=e[i].width()+2*o.options.rectMargin;return n},o._clear=function(){for(var e=0;e<o._trash.length;e++){var t=o._trash[e];t.remove()}o._trash=[]},o.options={tileRadius:80,tileMargin:10,hoverMargin:48,rectMargin:0,minArc:33,maxArc:99,debug:0,container:null},o.Box=n,o.Box.pathOptions=o.options,o});
define('game/canvas/vm/confirm-box',["./Path","./Box"],function(e){var t=paper,n=function(e){this._trash=[],this.hide=function(){for(var e=0;e<this._trash.length;e++)this._trash[e].remove()},t=e};return n.prototype.events={mouseenter:function(){this.style={shadowColor:"#b8b0a3",shadowBlur:3,shadowOffset:new t.Point(0,0)}},mouseleave:function(){this.style={shadowBlur:0}},mousedown:function(){}},n.prototype.show=function(e){this.hide(),this.showDoneCenter(e)},n.prototype.showBox=function(n,o){for(var i,a=0;a<o.length&&o[a].hasData;a++)i=o[a];var r=i.cPoint.add(n.getNormalAt(n.length/2).normalize(-60)).add([50,0]),s=this.createDoneContainer(),l=this.createDoneButton(new t.Point(0,0));s.position=r,l.position=r.add([0,15]);var d=new t.PointText({point:r.add([0,-15]),content:"Are you done?"});d.style=e.Box.options.textStyle,d.fontSize=12,d.fillColor="black",this._trash.push(d)},n.prototype.createDoneContainer=function(){var e=new t.Point(60,40),n=new t.Path.Rectangle(e.negate(),e);return this._trash.push(n),n.style={fillColor:"white",strokeColor:"#e8e0d3",shadowColor:"#b8b0a3",shadowBlur:5,shadowOffset:new t.Point(1,1)},n.bringToFront(),n},n.prototype.showDoneCenter=function(e){var t=50,n=e.length/2,o=e.getNormalAt(n).normalize(t),i=e.getPointAt(n).add(o),a=this.createDoneButton(i);a.rotate(e.getTangentAt(n).angle,i),this._trash.push(a)},n.prototype.createDoneButton=function(n){var o=new t.Group,i=new t.Point(30,15),a=new t.Path.Rectangle(n.subtract(i),n.add(i));a.strokeColor="#e8e0d3",a.fillColor="orange",a.strokeWidth=2;var r=new t.PointText({point:n,content:"Done"});return r.style=e.Box.options.textStyle,r.fillColor="white",r.position.y+=4,r.characterStyle.fontStyle="bold",o.addChild(a),a=a.clone(),o.addChild(a),o.addChild(r),a.fillColor=new t.Color(0,0),a.bringToFront(),a.on(this.events),this._trash.push(o),o},n});
define('game/canvas/vm/DynamicPath',["api/datacontext","./Box","./Path","./confirm-box","paper"],function(e,t,n){function o(e){var t=this;this.pathModel=e,this.activeWord=null,this.activeWords=null,this.events={mouseenter:function(){if(null!=i()){for(var e=t.pathModel.guiBoxes,n=i(),o=0;o<e.length;o++)e[o].enter(n);r=t,t.activeWord=n}else if(null!=a()){var s=a();if(s.length>=3&&s.length<=6){for(var e=t.pathModel.guiBoxes,o=0;o<e.length;o++)e[o].enter({});r=t,t.activeWords=s}}else{var l=t.pathModel;l&&l.onEnter&&l.onEnter(t.midPath)}},mouseleave:function(){if(r==t){for(var e=t.pathModel.guiBoxes,n=0;n<e.length;n++)e[n].leave();r=null,t.activeWord=null,t.activeWords=null}else{var o=t.pathModel;o&&o.onLeave&&o.onLeave()}}},this.events.mousedown=function(e){if(null!=t.activeWord)t.pathModel.addWord(t.activeWord),t.events.mouseleave(e);else if(null!=t.activeWords){for(var n=t.activeWords,o=0;o<n.length;o++)t.pathModel.addWord(n[o]);t.pathModel.phrase._complete(!0),t.pathModel.phrase.words.valueHasMutated(),t.events.mouseleave(e)}},this.drop=function(){t.events.mousedown()},this.draw=this.show}var i=e.activeWord,a=e.activeWords;new paper.Color(0,0);var r=null;return i.subscribe(function(e){null==e&&null!=r&&r.drop()}),o.prototype=new n,o.prototype.constructor=o,o.prototype.show=function(){console.log("%cDynamic Path","background: orange; color: white",this.pathModel.id+" is being drawn");var e=this.pathModel,o=6,i=e.phrase.words().length>=3&&!e.phrase.complete();i?(void 0==this.confirmBox&&(this.confirmBox=new t(-1,null),this.confirmBox.button(e),this.confirmBox.show()),e.guiBoxes.splice(o,0,this.confirmBox),o++):this.confirmBox&&(this.confirmBox.remove(),this.confirmBox=void 0),e.phrase.complete()===!0?(o=e.phrase.words().length,this._hideCircles()):this._showCircles(),this._cleanCycle();var a=n.getDesiredLength(e.guiBoxes,o),r=n.getBestArc(e.startTile.center,e.endTile.center,a,e.cw,o);this.cPoint=n.cPoint,this.midPath=r.getPointAt(r.length/2);var s=r.length-a,l=(r.length-2*(n.options.tileMargin+n.options.tileRadius),n.options.tileRadius+n.options.tileMargin),d=l,c=new paper.Path;c.add(e.startTile.center);for(var u=0;o>u;u++){var p=e.guiBoxes[u],h=p.width()/2+n.options.rectMargin+s/(2*o);d+=h;var g=r.getPointAt(d),f=r.getNormalAt(d).normalize(n.options.hoverMargin/1.5);c.add(g.subtract(f)),c.insert(0,g.add(f)),d+=h,p.cPoint=g,p.angle=f.angle+90,p.scale=s>=0?1:r.length/a,p.show()}if(c.on(this.events),c.fillColor=new paper.Color(0,0),c.add(e.endTile.center),c.closePath(),this._trash.push(c),i){for(var u=0;o>u;u++){var p=e.guiBoxes[u];if(p.isButton)break}e.guiBoxes.splice(u,1)}n.options.debug?(c.strokeColor="lightgreen",this._trash.push(r)):r.remove(),paper.view.draw()},o.prototype._hideCircles=function(){for(var e=0;e<this.pathModel.guiBoxes.length;e++)this.pathModel.guiBoxes[e].isCircle&&this.pathModel.guiBoxes[e].hideIfEmpty()},o.prototype._showCircles=function(){for(var e=0;e<this.pathModel.guiBoxes.length;e++)this.pathModel.guiBoxes[e].isCircle&&this.pathModel.guiBoxes[e].showIfEmpty()},o});
define('game/canvas/paths',["durandal/app","api/datacontext","game/canvas/vm/Path","game/canvas/vm/DynamicPath","paper"],function(e,t,n,o){function i(e){paper.dfd.promise().then(function(){console.log("UpdateModel");var t=$("#tiles"),o=t.parent();n.options.container={width:t.width(),height:t.height(),left:o.position().left,top:o.position().top},a(e)})}function a(e){function o(e,t){var o=new paper.Point;return o.x=n.options.container.width*e+n.options.container.left,o.y=n.options.container.height*t+n.options.container.top,o}e=e||t.tiles();for(var i=0;i<e.length;i++){var a=e[i];a.center=o(a.x,a.y)}}function r(e){paper.dfd.promise().then(function(){e.hasOwnProperty("canvas")||(e.canvas=0===e.nWords?new o(e):new n(e),s.call(e),e.canvasSub=e.phrase.words.subscribe(s,e),e.dispose=function(){console.log("%cPath Disposed","background: orange; color: white",e.id),e.canvasSub&&(e.canvasSub.dispose(),delete e.canvasSub),e.canvas&&(e.canvas.dispose(),delete e.canvas)})})}function s(){i(),this.canvas.setup(),this.canvas.show()}function l(e){console.log("paths setup"),paper.setup(e),paper.pathsCSize={w:$(e).width(),h:$(e).height()},p=e,paper.dfd.resolve()}function d(){var e=p.getContext("2d");e.canvas.width=$(p).width(),e.canvas.height=$(p).height(),i();for(var n=t.paths(),o=0;o<n.length;o++)n[o].canvas.show();paper.view.draw()}function c(){var e={w:$(p).width(),h:$(p).height()};paper.pathsCSize.w!=e.w||paper.pathsCSize.h!=e.h?(paper.pathsCSize=e,paper.setup(p),d(),console.log("resized occurred")):console.log("resized ignored")}function u(){console.log("paths disposed"),paper.dfd=$.Deferred()}var p;return e.on("app:resized").then(c),t.tiles.subscribe(function(e){i(e)}),t.paths.subscribe(function(e){for(var t=0;t<e.length;t++)r(e[t])}),paper.dfd=$.Deferred(),t.tiles().length&&t.tiles.notifySubscribers(t.tiles()),t.paths().length&&t.paths.notifySubscribers(t.paths()),e.on("game:tiles:update").then(a),e.on("app:force-resize").then(d),{setup:l,redraw:d,dispose:u}});
...
define('game-editor/tiles',["durandal/app","api/datacontext","api/draggable"],function(e,t){function n(){for(var e=0;e<i.length;e++){var t=i[e].$el,n=i[e].tile;t.css({left:100*n.x+"%",top:100*n.y+"%"}),t.find(".mask").css({scale:1,fontSize:"1em"}),n.ruleOffset={x:0,y:0},o(n,!0)}i=[]}function o(e,t){var n=e.angle();return e.$inst.css({rotate:n}),n>90||-90>n?e.$inst.find(".rule").css({rotate:180}):e.$inst.find(".rule").css({rotate:0}),void 0}var i=[];return{tiles:t.tiles,collection:t.collection,tileAngleUp:function(e){e.angle(e.angle()+1),o(e)},tileAngleDown:function(e){e.angle(e.angle()-1),o(e)},del:function(n){e.dialog.show("confirm",{content:"Delete tile?",modal:!0,doneText:"YES",cancelText:"NO"}).then(function(e){if("cancel"!=e){for(var o=t.paths(),i=0;i<o.length;i++){var a=o[i];(a.startTile.id==n.id||a.endTile.id==n.id)&&(t.paths.splice(t.paths.indexOf(a),1),a.dispose(),i--)}t.tiles.splice(t.tiles.indexOf(n),1)}})},afterRender:function(a,r){var s=$(a).filter(".tile:first");r.$el=s,r.$inst=s.find(".cloud"),r.$el.draggable({withinEl:s.parent(),centerBased:!0,topLimit:!0,dragStart:function(){r.lastAngle=r.angle(),r.lastX=r.x},move:function(e,t){return r.x=t.left/s.parent().innerWidth(),r.y=t.top/s.parent().innerHeight(),r.lastAngle>90||r.lastAngle<-90?r.angle(r.lastAngle-Math.floor(90*(r.x-r.lastX))):r.angle(r.lastAngle+Math.floor(90*(r.x-r.lastX))),o(r),!0},dropped:function(n,o){if(o.hasMoved){e.trigger("game:tiles:update");for(var i=t.paths(),a=0;a<i.length;a++){var r=i[a];if(r.startTile.x>r.endTile.x){var s=r.startTile;r.startTile=r.endTile,r.endTile=s,r.cw^=1}r.phrase.words.valueHasMutated()}}}}),r.$inst.find(".rule").draggable({withinEl:$(document),centerBased:!0,usePercentage:!1,topLimit:!1,move:function(e,t){var n=Math.ceil(90+Math.atan2(t.top,t.left)*(180/Math.PI));return r.angle(n),o(r),!1}}),0==i.length&&setTimeout(n,100),i.push({$el:s,tile:r})}}});
define('game/canvas/circleWords',["durandal/system","durandal/app","api/datacontext","paper"],function(e,t,n){function o(){$("canvas").unbind("mouseup"),paper.tool.remove()}function i(){s=new paper.Tool,stars=[],path,s.minDistance=16,s.maxDistance=32,s.onMouseDown=function(e){e.event.preventDefault(),path=new paper.Path,path.add(e.point),stars=[],addStarAt(e.point)},s.onMouseDrag=function(e){e.event.preventDefault(),path.add(e.point),addStarAt(e.point)},s.onMouseUp=function(){if(0!=path.length){path.closePath();var e=r(path,d());if(e.length<3)console.log("Too few words!");else if(e.length>9)console.log("Too many words!"),t.dialog.show("alert",{content:"Too many words!"});else{e=a(e);for(var n=0;n<e.length;n++)console.log(e[n].lemma);l.resolve(e)}path.remove(),t.trigger("app:force-resize")}},addStarAt=function(e){star=new paper.Raster("star"),star.position=e,star.rotate(Math.floor(360*Math.random())),star.scale(.4+.6*Math.random()),star.removeOnUp()}}function a(e){function t(e){upper=e[0],slightY=0;for(var t=1;t<e.length;t++){var n=e[t],o=upper.y-n.y;o-slightY>.06?(upper.x-n.x>.06,upper=n,slightY=0):o>0&&(slightY+=o)}return e.splice(e.indexOf(upper),1),upper}function n(e,t){return e.x-t.x}var o=[];for(e.sort(n);e.length;)o.push(t(e));return o}function r(e,t){var n=$("#app").scrollTop();return ko.utils.arrayFilter(t,function(t){var o=t.$el.offset().left+t.$el.innerWidth()/2,i=t.$el.offset().top+n+t.$el.innerHeight()/2;return e.contains(o,i)})}var s,l,d=n.unplayedWords;return circleWords={load:function(){return l=e.defer(),t.trigger("app:force-resize"),o(),i(),l.promise()},unload:o}});
define('text!game/game.html',[],function () { return '<div>\r\n   <img id="star" src="images/app/star.png" style="display: none;" />\r\n   <div class="logo page" data-1bind="css: { loading: loading }"></div>\r\n\r\n   <div id="game-main" data-bind="css: { loading: loading }">\r\n      <div id="game-players" data-bind="compose: \'game/players\'"></div>\r\n      <!--ko compose: { model: \'game/canvas\', mode: \'inline\' }--><canvas resize="true"></canvas><!--/ko-->\r\n      <!--ko compose: \'game/tiles\'--><!--/ko-->\r\n      <hr data-bind="visible: !loading()" />\r\n      <!--ko compose: \'game/words\'--><!--/ko-->\r\n   </div>   \r\n</div>\r\n';});

define('game/tutorial',["durandal/app","api/datacontext","dialogs/_constants"],function(e,t,o){function n(){this.swapWords=function(){var t=$(".palette.left .btn:first"),o=TUT.SWAP_WORDS;return o.css="left",o.top=t.offset().top+i.scrollTop,o.left=t.offset().left+60,o.fixed=!0,e.dialog.show("tutorial",o)},this.circleWords=function(){var t=$(".palette.left .btn:nth-child(2)"),o=TUT.SELECT_PHRASE;return o.css="left",o.top=t.offset().top+i.scrollTop,o.left=t.offset().left+60,o.fixed=!0,e.dialog.show("tutorial",o)},this.placePhrase=function(){var t=$(".magnet-placeholder").filter(function(){return $(this).offset().top>200?!0:!1}),o=TUT.PLACE_PHRASE;return o.css="bottom left",o.top=t.offset().top-150+i.scrollTop,o.left=t.offset().left,e.dialog.show("tutorial",o)},this.fillPath=function(){var t=$(".magnet-placeholder").filter(function(){return $(this).offset().top>200?!0:!1}),o=TUT.FILL_PATH;return o.css="bottom left",o.top=t.offset().top-90+i.scrollTop,o.left=t.offset().left,e.dialog.show("tutorial",o)},this.workspace=function(){var t=$("#workspace"),o=TUT.WORKSPACE;return o.css="bottom right",o.top=t.offset().top-150+i.scrollTop,o.left=200,e.dialog.show("tutorial",o)},this.gameboard=function(){var t=$(".magnet-placeholder:first"),o=TUT.GAMEBOARD;return o.css="bottom left",o.top=t.offset().top-130+i.scrollTop,o.left=t.offset().left,e.dialog.show("tutorial",o)},this.bonus=function(){var t=$(".cloud .info").filter(function(){return $(this).offset().top>220?!0:!1}),o=TUT.BONUS;return o.css="bottom left",o.top=t.offset().top-220+i.scrollTop,o.left=t.offset().left+20,e.dialog.show("tutorial",o)},this.relatedWords=function(){var t=$(".magnet.related:first");if(0==t.length)return $.Deferred(function(e){e.reject()});var o=TUT.RELATED;return o.css="bottom right",o.top=t.offset().top-170+i.scrollTop,o.left=t.offset().left-120,e.dialog.show("tutorial",o)}}TUT=o.TUT;var i=document.getElementById("app");return n.prototype.getNext=function(){return this.qIndex=this.qIndex||0,[this.placePhrase,this.fillPath,this.bonus,this.swapWords,this.circleWords,this.relatedWords][this.qIndex++]},n.prototype.showNext=function(){var e=this.getNext();if(!e)return localStorage.removeItem("tutorial"),$.Deferred();var t=this;return e().then(function(e){return e&&e.force?$.Deferred():t.showNext()},function(){localStorage.setItem("tutorial","related")})},n.prototype.show=function(){this.qIndex=0,localStorage.getItem("tutorial")&&("related"==localStorage.getItem("tutorial")&&(this.qIndex=5),this.showNext())},new n});
define('game/game',["durandal/app","durandal/system","api/datacontext","dialogs/_constants","./tutorial"],function(e,t,o,n,i){function a(e,t,o){var n,i;$(".player").each(function(t,o){return ko.dataFor(o)==e?(n=$(o),void 0):void 0}),i=ko.utils.arrayMap(t.guiBoxes,function(e){return e});for(var a=n.offset().left+20,r=n.offset().top,s=0;s<i.length;s++){var l=$(i[s]._guiElem),d=i[s].wordModel.lemma,c=ko.utils.arrayFirst(o.words,function(e){return e.lemma==d}).points;console.log(c);for(var u=0;3*c>u;u++){var p=$("<div/>",{"class":"star"}),h=(5*Math.random()+3)/10,g=l.offset();p.css({scale:h,x:g.left*(1/h),y:g.top*(1/h),backgroundColor:"#"+Math.floor(16777215*Math.random()).toString(16)}),setTimeout(function(e){$("#app").append(e[0]),setTimeout(function(e){var t=1.3*Math.random()+.4;e[0].css({x:a*(t/e[1]),y:r*(t/e[1]),scale:e[1]/t,opacity:0});var o=e[0][0];o.addEventListener($.support.transitionEnd,function(){(o.parentNode||o.parentElement)&&(o.removeEventListener($.support.transitionEnd),o.remove?o.remove():(o.parentElement?o.parentElement.removeChild(o):o.parentNode.removeChild(o),console.log("second attempt")))})},0,e)},700*Math.random(),[p,h])}}}function r(e){var t,n,i;$(".rule").each(function(a,r){return ko.dataFor(r)==e?(t=$(r),n=t.parent(),i=2*(e.bonus||(o.player.scored||o.player.score())*e.mul||20),void 0):void 0}),0==l++%2?t.transition({scale:1.2},{easing:"ease-in-out"}).transition({scale:.9},{easing:"ease-in-out"}).transition({scale:1},{easing:"ease-in-out"}):t.transition({rotate:"+=15"},{easing:"ease-in-out"}).transition({rotate:"-=30"},{easing:"ease-in-out"}).transition({rotate:"+=15"},{easing:"ease-in-out"});for(var a=0;i>a;a++){var r=$("<div/>",{"class":"star"}),s=(5*Math.random()+3)/10;t.position(),t.offset(),r.css({scale:s,left:60,top:-20});var d=200;setTimeout(function(e){n.append(e[0]),setTimeout(function(e){var t=1.3*Math.random()+.4,o=360*Math.random(),n=d*Math.cos(o*Math.PI/180),i=d*Math.sin(o*Math.PI/180);e[0].css({x:n*(t/e[1]),y:i*(t/e[1]),scale:e[1]/t,opacity:.1});var a=e[0][0];a.addEventListener($.support.transitionEnd,function(){(a.parentNode||a.parentElement)&&(a.removeEventListener($.support.transitionEnd),a.remove?a.remove():(a.parentElement?a.parentElement.removeChild(a):a.parentNode.removeChild(a),console.log("second attempt")))})},0,e)},700*Math.random(),[r,s])}}function s(){return o.gameOver()||o.resumedGame?(e.trigger("game:started:ready"),void 0):(document.getElementById("app").classList.add("noScroll"),setTimeout(function(){e.scrollDown(0,!0),setTimeout(e.scrollUp,800,!0),setTimeout(function(){document.getElementById("app").classList.remove("noScroll"),e.trigger("game:started:ready")},1500)},800),void 0)}o.canSwap=ko.observable(!1),o.loading.subscribe(function(t){t===!0?e.loading(!1):t===!1&&e.palette.show()}),$(document).keydown(function(t){location.hash.match(/game/gi)&&(84==t.keyCode?(localStorage.setItem("tutorial",!0),i.show()):83==t.keyCode?s():85==t.keyCode||(86==t.keyCode?e.trigger("game:rule:toggle"):87==t.keyCode&&(r(o.tiles()[0]),r(o.tiles()[1]))))});var l=0;e.on("game:updated").then(function(e){o.canSwap(o.player.active()),console.log(e),o.player.scored&&(a(o.player,o.lastPath,e.path.score),e.path.score.startTile.satisfied&&r(o.lastPath.startTile),e.path.score.endTile.satisfied&&r(o.lastPath.endTile))}),e.on("game:started").then(function(){o.canSwap(o.player.active()&&!o.actionDone),setTimeout(function(){s()},100)}),e.on("game:started:ready").then(function(){setTimeout(function(){i.show()},500)});var d=function(){e.dialog.close("confirm"),e.dialog.close("slipper"),o.canSwap(!0),o.mode("");for(var t=o.selectedWords(),n=0;n<t.length;n++)t[n].isSelected(!1);paper.tool.remove()},c=ko.computed(function(){return!o.gameOver()}),u=ko.computed(function(){return o.player.active()}),p={loadingStatus:o.loadingStatus,loading:o.loading,player:o.player,allowSwap:ko.computed(function(){return c()&&u()&&o.canSwap()&&(""===o.mode()||"swapWords"===o.mode())}),allowResign:ko.computed(function(){return c()}),allowCircle:ko.computed(function(){return c()&&u()&&(""===o.mode()||"circleWords"==o.mode())}),mode:o.mode,swapWords:function(){if("swapWords"==o.mode())d();else if(p.allowSwap()){e.dialog.show("slipper",n.SWAP_WORDS),o.mode("swapWords"),e.scrollDown();var t=!1,i=p;i._wordsSub=o.selectedWords.subscribe(function(n){n.length>0&&!t?(t=!0,e.dialog.show("confirm").then(function(t){if(i._wordsSub.dispose(),"cancel"==t)d();else if("done"==t){e.dialog.close("slipper"),o.loadingStatus("Swapping words"),e.loading(!0);var n={username:o.player.username,gameID:o.gameID,words:ko.utils.arrayMap(o.selectedWords(),function(e){return e.id})};e.trigger("server:game:swap-words",n,function(t){t.success?o.canSwap(!1):d(),o.mode(""),e.loading(!1)})}})):n.length<=0&&t&&(t=!1,e.dialog.close("confirm"))})}},resign:function(){if(!o.gameOver()){var t=1==o.playerCount?"Would you like to delete this game?":"Are you sure you want to resign?";e.dialog.show("confirm",{content:t,modal:!0,doneText:"YES",cancelText:"NO"}).then(function(t){"cancel"!=t&&e.trigger("server:game:resign",{username:o.player.username,gameID:o.gameID})})}},circleWords:function(){if(p.allowCircle()){var i={load:function(){e.dialog.show("slipper",n.CIRCLE_WORDS),e.scrollDown(),t.acquire("game/canvas/circleWords").then(function(t){t.load().then(function(t){e.scrollUp(),o.activeWords(t),i.unload()})}),o.activeWords(null)},unload:function(){e.dialog.close("slipper"),o.mode(""),paper.tool.remove()}};"circleWords"==o.mode()?i.unload():(o.mode("circleWords"),i.load())}}};return t.extend(p,{noTransite:!0,activate:function(t){e.loading(!0),e.trigger("game:dispose"),e.palette.dispose(),e.dialog.closeAll(),e.palette.hide({duration:0}),e.palette.add("quit","command","right").click(p.resign).css({disabled:ko.computed(function(){return!p.allowResign()})}),e.palette.add("swapWords","action","left").click(p.swapWords).css({cancel:ko.computed(function(){return"swapWords"===p.mode()}),disabled:ko.computed(function(){return!p.allowSwap()})}),e.palette.add("circleWords","action","left").click(p.circleWords).css({cancel:ko.computed(function(){return"circleWords"===p.mode()}),disabled:ko.computed(function(){return!p.allowCircle()})}),o.load(t)},binding:function(){return{cacheViews:!1}},compositionComplete:function(){},detached:function(){o.unload(),e.dialog.closeAll();for(var t=o.paths(),n=0;n<t.length;n++)t[n].dispose();o.paths.removeAll(),o.tiles.removeAll(),o.words.removeAll(),e.palette.dispose()}})});
...
define('game/tiles',["durandal/app","api/datacontext","api/draggable"],function(e,t){function o(e,t){if(h){var o=e.$inst,n=e.topOffset;n-t>0&&(o.appendTo(e.$parent).removeClass("fixed").css({left:0,top:0}),delete e.isFixed)}}function n(e,t){if(h){var o=e.$inst,n=o.find(".rule");if(elTop=n.offset().top,0>=elTop){var i=0,a=n.offset().left;e.topOffset=t+elTop,e.$parent=o.parent(),e.isFixed=!0,o.offset({left:a,top:i}).addClass("fixed").appendTo("body"),o.offset({left:a,top:i})}}}function i(){if(h)for(var e=document.getElementById("app").scrollTop,t=0;t<u.length;t++)u[t].active()||(u[t].$inst,u[t].isFixed?o(u[t],e):n(u[t],e))}function a(){r();for(var e=t.tiles(),o=0;o<e.length;o++)e[o].active()||(l(e[o]),s(e[o],!1))}function r(){p.w=$("#tiles").innerWidth(),p.h=$("#tiles").innerHeight(),p.ww=$("#tiles-max").innerWidth(),p.hh=$("#tiles-max").innerHeight(),e.el.clientWidth<900&&(p.hh+=100)}function s(e,t){0!=p.h&&(t||e.$mask.addClass("noTransition"),e.origin=e.origin||{scale:1,h:e.$mask.outerHeight()},e.active()?(e.origin.scale=e.origin.h/p.hh,e.$mask.css({fontSize:1/e.origin.scale+"em"})):(e.origin.scale=e.origin.h/p.hh,e.$mask.css({scale:e.origin.scale,fontSize:1/e.origin.scale+"em"})),t||setTimeout(function(){e.$mask.removeClass("noTransition")},1))}function l(e,t){0!=p.h&&(t?e.$el.css({transform:""}):e.$el.css({x:e.x*p.w-p.w/2,y:e.y*p.h-p.h/2}))}function d(e){var t=e.angle;return e.$inst.css({rotate:t}),(t>90||-90>t)&&e.$inst.find(".rule").css({rotate:180}),void 0}function c(){$("#app").unbind("scroll",i);for(var e=0;e<u.length;e++){var t=u[e].$inst;u[e].isFixed&&ko.removeNode(t[0])}u.splice(0,u.length)}var u=[],p={w:0,h:0,ww:0,hh:0},h=!1;e.on("game:rule:toggle").then(function(){if(h)for(var e=0;e<u.length;e++)o(u[e],0);h=!h}),e.on("app:resized").then(a),e.on("game:dispose").then(c);var g=ko.observable(!0);return e.on("game:started").then(function(){t.gameOver()&&t.resumedGame&&g(!1)}),e.on("game:tiles:visible",function(e){g(e)}),{tiles:t.tiles,gameOver:t.gameOver,forceVisible:g,collection:t.collection,carryingWords:ko.computed(function(){return t.activeWords()||t.activeWord()}),disabled:ko.computed(function(){var e=t.mode();return"swapWords"==e||"circleWords"==e}),activate:function(){$("#app, body").bind("scroll",i)},binding:function(){return{cacheViews:!1}},compositionComplete:function(){a()},toggleTile:function(t){var n=this.active();n?(setTimeout(i,500),l(t,!1),t.$mask.css({scale:t.origin.scale})):(t.isFixed&&o(t,0),l(t,!0),t.$mask.css({scale:1}),e.scrollUp()),t.active(!n)},help:function(t,o){if(t.active())return o.stopPropagation=!1,!0;var n=t.$inst.offset(),i=n.left,a=n.top+200-$("#app").scrollTop();t.isFixed&&(a-=120),a=150,e.dialog.show("window",{heading:t.instruction,content:t.description,left:i,top:a})},afterRender:function(e,t){var o=$(e).filter(".tile:first");t.$el=o,t.$inst=o.find(".cloud"),t.$mask=o.find(".mask"),t.ruleOffset={x:0,y:0},l(t),s(t,!1),d(t),u.push(t)},detached:c}});
...
define('home/test',["durandal/app","api/datacontext"],function(e){return{binding:function(){return{cacheViews:!1}},compositionComplete:function(t){for(var n=0;16>n;n++){var o=$("<div/>",{"class":"shiny"});o.addClass(0==n%5?"typeA":1==n%5?"typeB":2==n%5?"typeC":3==n%5?"typeD":"typeE");var i=40*Math.random();o.css({width:i,left:50-i/2,opacity:0,scale:.99}),$(".shine",t).append(o),setTimeout(function(e){e.l.css({opacity:1,width:e.w,left:50-e.w/2})},300*n,{l:o,w:i+30}),setTimeout(function(e){e.css({opacity:0})},200*n+2e3,o)}setTimeout(function(){e.scrollDown(),e.scrollUp()},1e3)}}});
requirejs.config({paths:{text:"../lib/requirejs-text/text",durandal:"../lib/durandal",plugins:"../lib/durandal/plugins",transitions:"../lib/durandal/transitions","crypto.sha3":"../lib/crypto.sha3",facebook:"//connect.facebook.net/en_US/all"},urlArgs:"t"+(new Date).getTime(),shim:{facebook:{"export":"FB"}}}),define("jquery",[],function(){return jQuery}),define("knockout",ko),define("socket",io),define("paper",paper),define('main',["durandal/system","durandal/app","plugins/router","durandal/viewLocator","common"],function(e,t,n,o){function i(e){var t=document.createElement("link");t.type="text/css",t.rel="stylesheet",t.href="css/"+e+".css",document.getElementsByTagName("head")[0].appendChild(t)}e.debug(!0),t.title="Words of Oz",t.configurePlugins({router:!0}),t.start().then(function(){o.useConvention(),t.setRoot("shell",null,"app")}),void 0===document.body.style.backgroundPositionX&&i("_sprites"),void 0!==document.body.style.MozAppearance&&i("_firefox"),t.browser.android||i("_ipad"),window.app=t});
