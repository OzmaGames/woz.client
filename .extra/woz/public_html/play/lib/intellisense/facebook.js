/*1402588640,,JIT Construction: v1286616,en_US*/
...
try {
   window.FB || ( function ( window ) {
      ...
      ( function ( global ) {
         ...
         require = __w( function (/*string*/ id, /*boolean?*/ soft ) {
            __t( [id, 'string', 'id'], [soft, '?boolean', 'soft'] );
         ...
         __d = __w( function (/*string*/ id, /*array<string>*/ deps, factory,
             /*number?*/ _special ) {
            __t( [id, 'string', 'id'], [deps, 'array<string>', 'deps'], [_special, '?number', '_special'] );
    ...
    /* 2KL294koxM_ */
      ...
      __d( "QueryString", [], function ( global, require, requireDynamic, requireLazy, module, exports ) {
         ...
         } __w( encode, { "signature": "function(object):string" } );


         function decode(/*string*/ str, /*?boolean*/ strict ) /*object*/ {
            __t( [str, 'string', 'str'], [strict, '?boolean', 'strict'] ); return __t( [function () {
               var data = {};
               if ( str === '' ) {
                  return data;
               }
         ...
         } __w( decode, { "signature": "function(string,?boolean):object" } );


         function appendToUrl(/*string*/ url, params ) /*string*/ {
            __t( [url, 'string', 'url'] ); return __t( [function () {
               return url +
         ...
         } __w( appendToUrl, { "signature": "function(string):string" } );
      ...
      __d( "sprintf", [], function ( global, require, requireDynamic, requireLazy, module, exports ) {
         ...
         function sprintf( format ) {
            __t( [format, 'string', 'format'] ); var args = Array.prototype.slice.call( arguments, 1 );
            var index = 0;
      ...
      __d( "Assert", ["AssertionError", "sprintf"], function ( global, require, requireDynamic, requireLazy, module, exports, AssertionError, sprintf ) {
         ...
         function assert(/*boolean*/ expression, /*?string*/ message ) /*boolean*/ {
            __t( [expression, 'boolean', 'expression'], [message, '?string', 'message'] ); return __t( [function () {
               if ( typeof expression !== 'boolean' || !expression ) {
                  throw new AssertionError( message );
               }
               return expression;
            }.apply( this, arguments ), 'boolean'] );
         } __w( assert, { "signature": "function(boolean,?string):boolean" } );


         function assertType(/*string*/ type, expression, /*?string*/ message ) {
            __t( [type, 'string', 'type'], [message, '?string', 'message'] );
            var actualType;
         ...
         function assertInstanceOf(/*function*/ type, expression, /*?string*/ message ) {
            __t( [type, 'function', 'type'], [message, '?string', 'message'] );
            assert(
         ...
         function define(/*string*/ type, /*function*/ test ) {
            __t( [type, 'string', 'type'], [test, 'function', 'test'] );
            Assert['is' + type] = test;
         ...
         var Assert = {
            ...
            isTrue: assert,
            isTruthy: __w( function ( expression, /*?string*/ message ) /*boolean*/ {
               __t( [message, '?string', 'message'] ); return __t( [function () {
                  return assert( !!expression, message );
               }.apply( this, arguments ), 'boolean'] );
            }, { "signature": "function(?string):boolean" } ),
            type: assertType,
            define: __w( function (/*string*/ type, /*function*/ fn ) {
               __t( [type, 'string', 'type'], [fn, 'function', 'fn'] );
         ...
         ES5( ['Array',
          ...
          'Regexp',
          'String',
          'Undefined'], 'forEach', true, __w( function (/*string*/ type ) {
             __t( [type, 'string', 'type'] );
      ...
      __d( "Type", ["copyProperties", "Assert"], function ( global, require, requireDynamic, requireLazy, module, exports, copyProperties, Assert ) {
         ...
         function instanceOf(/*function*/ constructor, which ) /*boolean*/ {
            __t( [constructor, 'function', 'constructor'] ); return __t( [function () {
         ...
         } __w( instanceOf, { "signature": "function(function):boolean" } );


         function mixin(/*function*/ to, from ) {
            __t( [to, 'function', 'to'] );
         ...
         function extend(/*?function*/ from, /*?object*/ prototype, mixins )
            /*function*/ {
            __t( [from, '?function', 'from'], [prototype, '?object', 'prototype'] ); return __t( [function () {
               ...
               constructor.prototype.parentCall = __w( function (/*string*/ method ) {
                  __t( [method, 'string', 'method'] );
                  return from.prototype[method].apply( this,
                    Array.prototype.slice.call( arguments, 1 ) );
               }, { "signature": "function(string)" } );

               constructor.extend = __w( function (/*?object*/ prototype, mixins ) {
                  __t( [prototype, '?object', 'prototype'] );
                  return extend( this, prototype, mixins );
               }, { "signature": "function(?object)" } );
               return constructor;
            }.apply( this, arguments ), 'function'] );
         } __w( extend, { "signature": "function(?function,?object):function" } );

         copyProperties( Type.prototype, {
            instanceOf: __w( function (/*function*/ type ) /*boolean*/ {
               __t( [type, 'function', 'type'] ); return __t( [function () {
                  return instanceOf( type, this );
               }.apply( this, arguments ), 'boolean'] );
            }, { "signature": "function(function):boolean" } )
         } );

         copyProperties( Type, {
            extend: __w( function ( prototype, mixins ) /*function*/ {
               return __t( [function () {
      ...
      __d( "ObservableMixin", [], function ( global, require, requireDynamic, requireLazy, module, exports ) {
         ...
         ObservableMixin.prototype = {
            ...
            inform: __w( function (/*string*/ what /*, args*/ ) {
               __t( [what, 'string', 'what'] );
            ...
            getSubscribers: __w( function (/*string*/ toWhat ) /*array*/ {
               __t( [toWhat, 'string', 'toWhat'] ); return __t( [function () {
            ...
            clearSubscribers: __w( function (/*string*/ toWhat ) {
               __t( [toWhat, 'string', 'toWhat'] );
            ...
            subscribe: __w( function (/*string*/ toWhat, /*function*/ withWhat ) {
               __t( [toWhat, 'string', 'toWhat'], [withWhat, 'function', 'withWhat'] );
            ...
            unsubscribe: __w( function (/*string*/ toWhat, /*function*/ withWhat ) {
               __t( [toWhat, 'string', 'toWhat'], [withWhat, 'function', 'withWhat'] );
            ...
            monitor: __w( function (/*string*/ toWhat, /*function*/ withWhat ) {
               __t( [toWhat, 'string', 'toWhat'], [withWhat, 'function', 'withWhat'] );
               if ( !withWhat() ) {
      ...
      __d( "sdk.Model", ["Type", "ObservableMixin"], function ( global, require, requireDynamic, requireLazy, module, exports, Type, ObservableMixin ) {
         ...
         var Model = Type.extend( {
            constructor: __w( function (/*object*/ properties ) {
               __t( [properties, 'object', 'properties'] );
               this.parent();
               ...
               ES5( ES5( 'Object', 'keys', false, properties ), 'forEach', true, __w( function (/*string*/ name ) {
                  __t( [name, 'string', 'name'] );
      ...
      __d( "sdk.Runtime", ["sdk.Model", "JSSDKRuntimeConfig", "copyProperties"], function ( global, require, requireDynamic, requireLazy, module, exports, Model, RuntimeConfig, copyProperties ) {
         ...
         copyProperties( Runtime, {
            ...
            isEnvironment: __w( function (/*number*/ target ) /*boolean*/ {
               __t( [target, 'number', 'target'] ); return __t( [function () {
                  var environment = this.getEnvironment();
                  return ( target | environment ) === environment;
               }.apply( this, arguments ), 'boolean'] );
            }, { "signature": "function(number):boolean" } )
         } );
      ...
      __d( "sdk.Cookie", ["QueryString", "sdk.Runtime"], function ( global, require, requireDynamic, requireLazy, module, exports, QueryString, Runtime ) {
         ...
         function setRaw(/*string*/ prefix, /*string*/ val, /*number*/ ts ) {
            __t( [prefix, 'string', 'prefix'], [val, 'string', 'val'], [ts, 'number', 'ts'] );
         ...
         function getRaw(/*string*/ prefix ) /*string?*/ {
            __t( [prefix, 'string', 'prefix'] ); return __t( [function () {
               prefix = prefix + Runtime.getClientID();
         ...
         } __w( getRaw, { "signature": "function(string):string?" } );

         var Cookie = {
            setDomain: __w( function (/*string?*/ val ) {
               __t( [val, '?string', 'val'] );
               domain = val;
            ...
            loadSignedRequest: __w( function () /*string?*/ {
               return __t( [function () {
                  return getRaw( 'fbsr_' );
               }.apply( this, arguments ), '?string'] );
            }, { "signature": "function():string?" } ),
            ...
            setSignedRequestCookie: __w( function (/*string*/ signedRequest,
                /*number*/ expiration ) {
               __t( [signedRequest, 'string', 'signedRequest'], [expiration, 'number', 'expiration'] );
               if ( !signedRequest ) {
      ...
      __d( "hasNamePropertyBug", ["guid", "UserAgent"], function ( global, require, requireDynamic, requireLazy, module, exports, guid, UserAgent ) {
         ...
         } __w( test, { "signature": "function():boolean" } );

         function hasNamePropertyBug() /*boolean*/ {
            return __t( [function () {
               return typeof hasBug === 'undefined'
                 ? test()
                 : hasBug;
            }.apply( this, arguments ), 'boolean'] );
         } __w( hasNamePropertyBug, { "signature": "function():boolean" } );
      ...
      __d( "wrapFunction", [], function ( global, require, requireDynamic, requireLazy, module, exports ) {
         ...
         function wrapFunction(/*function*/ fn, /*?string*/ type, /*?string*/ source )
            /*function*/ {
            __t( [fn, 'function', 'fn'], [type, '?string', 'type'], [source, '?string', 'source'] ); return __t( [function () {
               type = type || 'default';
         ...
         } __w( wrapFunction, { "signature": "function(function,?string,?string):function" } );

         wrapFunction.setWrapper = __w( function (/*function*/ fn, /*?string*/ type ) {
            __t( [fn, 'function', 'fn'], [type, '?string', 'type'] );
            type = type || 'default';
            wrappers[type] = fn;
      ...
      __d( "DOMEventListener", ["wrapFunction"], function ( global, require, requireDynamic, requireLazy, module, exports, wrapFunction ) {
         ...
         if ( window.addEventListener ) {
            ...
            add = __w( function ( target, /*string*/ name, /*function*/ listener ) {
               __t( [name, 'string', 'name'], [listener, 'function', 'listener'] );
               listener.wrapper =
                 wrapFunction( listener, 'entry', 'DOMEventListener.add ' + name );
               target.addEventListener( name, listener.wrapper, false );
            }, { "signature": "function(string,function)" } );
            remove = __w( function ( target, /*string*/ name, /*function*/ listener ) {
               __t( [name, 'string', 'name'], [listener, 'function', 'listener'] );
      ...
      __d( "sdk.createIframe", ["copyProperties", "guid", "hasNamePropertyBug", "DOMEventListener"], function ( global, require, requireDynamic, requireLazy, module, exports, copyProperties, guid, hasNamePropertyBug, DOMEventListener ) {
         ...
         function createIframe(/*object*/ opts ) /*DOMElement*/ {
            __t( [opts, 'object', 'opts'] ); return __t( [function () {
         ...
         } __w( createIframe, { "signature": "function(object):DOMElement" } );
      ...
      __d( "DOMWrapper", [], function ( global, require, requireDynamic, requireLazy, module, exports ) {
         ...
         var DOMWrapper = {
            setRoot: __w( function (/*DOMElement?*/ root ) {
               __t( [root, '?DOMElement', 'root'] );
               rootElement = root;
            }, { "signature": "function(?DOMElement)" } ),
            getRoot: __w( function () /*DOMElement*/ {
               return __t( [function () {
      ...
      __d( "sdk.feature", ["JSSDKConfig"], function ( global, require, requireDynamic, requireLazy, module, exports, SDKConfig ) {
         ...
         function feature(/*string*/ name, defaultValue ) {
            __t( [name, 'string', 'name'] );
      ...
      __d( "sdk.getContextType", ["UserAgent", "sdk.Runtime"], function ( global, require, requireDynamic, requireLazy, module, exports, UserAgent, Runtime ) {
         ...
         function getContextType() /*number*/ {
            return __t( [function () {
         ...
         } __w( getContextType, { "signature": "function():number" } );
      ...
      __d( "UrlMap", ["UrlMapConfig"], function ( global, require, requireDynamic, requireLazy, module, exports, UrlMapConfig ) {
         ...
         var UrlMap = {
            ...
            resolve: __w( function (/*string*/ key, /*boolean?*/ https ) /*string*/ {
               __t( [key, 'string', 'key'], [https, '?boolean', 'https'] ); return __t( [function () {
            ...
            }, { "signature": "function(string,?boolean):string" } )
         };
      ...
      __d( "sdk.Impressions", ["guid", "QueryString", "sdk.Runtime", "UrlMap"], function ( global, require, requireDynamic, requireLazy, module, exports, guid, QueryString, Runtime, UrlMap ) {
         ...
         var Impressions = {
            log: __w( function (/*number*/ lid, /*object*/ payload ) {
               __t( [lid, 'number', 'lid'], [payload, 'object', 'payload'] );
               if ( !payload.source ) {
      ...
      __d( "Log", ["sprintf"], function ( global, require, requireDynamic, requireLazy, module, exports, sprintf ) {
         ...
         function log(/*string*/ name, /*number*/ level/*, args*/ ) {
            __t( [name, 'string', 'name'], [level, 'number', 'level'] );
      ...
      __d( "sdk.SignedRequest", ["Base64"], function ( global, require, requireDynamic, requireLazy, module, exports, Base64 ) {
         ...
         function parse(/*string?*/ signed_request ) /*object?*/ {
            __t( [signed_request, '?string', 'signed_request'] ); return __t( [function () {
               if ( !signed_request ) {
                  return null;
               }
         ...
         } __w( parse, { "signature": "function(?string):object?" } );
      ...
      __d( "URIRFC3986", [], function ( global, require, requireDynamic, requireLazy, module, exports ) {
         ...
         var URIRFC3986 = {
            ...
            parse: __w( function ( uriString ) {
               __t( [uriString, 'string', 'uriString'] ); return __t( [function () {
      ...
      __d( "URISchemes", ["createObjectFrom"], function ( global, require, requireDynamic, requireLazy, module, exports, createObjectFrom ) {
         ...
         var URISchemes = {
            ...
            isAllowed: __w( function ( schema ) {
               __t( [schema, '?string', 'schema'] ); return __t( [function () {
                  if ( !schema ) {
                     return true;
                  }
      ...
      __d( "URIBase", ["URIRFC3986", "URISchemes", "copyProperties", "ex", "invariant"], function ( global, require, requireDynamic, requireLazy, module, exports, URIRFC3986, URISchemes, copyProperties, ex, invariant ) {
         ...
         URIBase.prototype.getProtocol = function ( protocol ) {
            "use strict";
      ...
      __d( "sdk.Content", ["sdk.domReady", "Log", "UserAgent"], function ( global, require, requireDynamic, requireLazy, module, exports, domReady, Log, UserAgent ) {
         ...
         var Content = {
            ...
            append: __w( function (/*DOMElement|string*/ content, /*?DOMElement*/ root )
               /*DOMElement*/ {
               __t( [content, 'DOMElement|string', 'content'], [root, '?DOMElement', 'root'] ); return __t( [function () {
            ...
            }, { "signature": "function(DOMElement|string,?DOMElement):DOMElement" } ),


            appendHidden: __w( function (/*DOMElement|string*/ content ) /*DOMElement*/ {
               __t( [content, 'DOMElement|string', 'content'] ); return __t( [function () {
                  if ( !hiddenRoot ) {
                     var
            ...
            submitToTarget: __w( function (/*object*/ opts, /*?boolean*/ get ) {
               __t( [opts, 'object', 'opts'], [get, '?boolean', 'get'] );
               var form = document.createElement( 'form' );
      ...
      __d( "sdk.Event", [], function ( global, require, requireDynamic, requireLazy, module, exports ) {
         var Event = {
            ...
            subscribers: __w( function () /*object*/ {
               return __t( [function () {
            ...
            subscribe: __w( function (/*string*/ name, /*function*/ cb ) {
               __t( [name, 'string', 'name'], [cb, 'function', 'cb'] );
            ...
            unsubscribe: __w( function (/*string*/ name, /*function*/ cb ) {
               __t( [name, 'string', 'name'], [cb, 'function', 'cb'] );
            ...
            monitor: __w( function (/*string*/ name, /*function*/ callback ) {
               __t( [name, 'string', 'name'], [callback, 'function', 'callback'] );
               if ( !callback() ) {
                  var
                    ctx = this,
                    fn = function () {
            ...
            clear: __w( function (/*string*/ name ) {
               __t( [name, 'string', 'name'] );
               delete this.subscribers()[name];
            }, { "signature": "function(string)" } ),


            fire: __w( function (/*string*/ name ) {
               __t( [name, 'string', 'name'] );
               var
      ...
      __d( "JSONRPC", ["copyProperties", "Log"], function ( global, require, requireDynamic, requireLazy, module, exports, copyProperties, Log ) {
         ...
         function JSONRPC(/*function*/ write ) {
            __t( [write, 'function', 'write'] );
            this._counter = 0;
            this._callbacks = {};
         ...
         copyProperties( JSONRPC.prototype, {
            ...
            stub: __w( function (/*string*/ stub ) {
               __t( [stub, 'string', 'stub'] );
            ...
            read: __w( function (/*string*/ message, context ) {
               __t( [message, 'string', 'message'] );
               ...
               if ( id ) {
                  ...
                  send = __w( function (/*string*/ type, value ) {
                     __t( [type, 'string', 'type'] );
                     var response = {
                        jsonrpc: '2.0',
                        id: id
      ...
      __d( "sdk.RPC", ["Assert", "JSONRPC", "Queue"], function ( global, require, requireDynamic, requireLazy, module, exports, Assert, JSONRPC, Queue ) {
         ...
         var jsonrpc = new JSONRPC( __w( function (/*string*/ message ) {
            __t( [message, 'string', 'message'] );
         ...
         var RPC = {
            ...
            setInQueue: __w( function (/*object*/ queue ) {
               __t( [queue, 'object', 'queue'] );
               Assert.isInstanceOf( Queue, queue );

               queue.start( __w( function (/*string*/ message ) {
                  __t( [message, 'string', 'message'] );
                  jsonrpc.read( message );
               }, { "signature": "function(string)" } ) );
            }, { "signature": "function(object)" } ),
            getOutQueue: __w( function () /*object*/ {
               return __t( [function () {
                  return outQueue;
               }.apply( this, arguments ), 'object'] );
            }, { "signature": "function():object" } )
      ...
      __d( "sdk.Scribe", ["QueryString", "sdk.Runtime", "UrlMap"], function ( global, require, requireDynamic, requireLazy, module, exports, QueryString, Runtime, UrlMap ) {
         ...
         function log(/*string*/ category, /*object*/ data ) {
            __t( [category, 'string', 'category'], [data, 'object', 'data'] );
      ...
      __d( "GlobalCallback", ["DOMWrapper", "dotAccess", "guid", "wrapFunction"], function ( global, require, requireDynamic, requireLazy, module, exports, DOMWrapper, dotAccess, guid, wrapFunction ) {
         ...
         var GlobalCallback = {
            ...
            setPrefix: __w( function (/*string*/ prefix ) {
               __t( [prefix, 'string', 'prefix'] );
               rootObject = dotAccess( DOMWrapper.getWindow(), prefix, true );
               callbackPrefix = prefix;
            }, { "signature": "function(string)" } ),

            create: __w( function (/*function*/ fn, /*string?*/ description ) /*string*/ {
               __t( [fn, 'function', 'fn'], [description, '?string', 'description'] ); return __t( [function () {
                  if ( !rootObject ) {
            ...
            }, { "signature": "function(function,?string):string" } ),

            remove: __w( function (/*string*/ name ) {
               __t( [name, 'string', 'name'] );
      ...
      __d( "sdk.XD", ["sdk.Content", "sdk.Event", "Log", "QueryString", "Queue", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "UrlMap", "JSSDKXDConfig", "XDM", "sdk.createIframe", "sdk.feature", "guid"], function ( global, require, requireDynamic, requireLazy, module, exports, Content, Event, Log, QueryString, Queue, RPC, Runtime, Scribe, URI, UrlMap, XDConfig, XDM, createIframe, feature, guid ) {
         ...
         function onRegister(/*string*/ registeredAs ) {
            __t( [registeredAs, 'string', 'registeredAs'] );
         ...
         function handleAction(/*object*/ message, /*string*/ senderOrigin ) {
            __t( [message, 'object', 'message'], [senderOrigin, 'string', 'senderOrigin'] );
            if ( !senderOrigin ) {
            ...
            switch ( message.xd_action ) {
               case 'proxy_ready':
                  ...
                  proxyQueue.start( __w( function (/*string|object*/ message ) {
                     __t( [message, 'string|object', 'message'] );
                     xdm.send(
         ...
         function onMessage(/*string|object*/ message, /*?string*/ senderOrigin ) {
            __t( [message, 'string|object', 'message'], [senderOrigin, '?string', 'senderOrigin'] );
         ...
         function sendToFacebook(/*string*/ recipient, /*object|string*/ message ) {
            __t( [recipient, 'string', 'recipient'], [message, 'object|string', 'message'] );
         ...
         RPC.getOutQueue().start( __w( function (/*string*/ message ) {
            __t( [message, 'string', 'message'] );
            sendToFacebook( 'facebook', 'FB_RPC:' + message );
         }, { "signature": "function(string)" } ) );

         function init(/*?string*/ xdProxyName ) {
            __t( [xdProxyName, '?string', 'xdProxyName'] );
            if ( inited ) {
               return;
            }
            ...
            var transport = XDM.create( {
               ...
               whenReady: __w( function (/*object*/ instance ) {
                  __t( [instance, 'object', 'instance'] );
                  xdm = instance;
         ...
         var XD = {
            ...
            inform: __w( function (/*string*/ method, /*?object*/ params, /*?string*/ relation,
                /*?string*/ behavior ) {
               __t( [method, 'string', 'method'], [params, '?object', 'params'], [relation, '?string', 'relation'], [behavior, '?string', 'behavior'] );
            ...
            handler: __w( function (/*function*/ cb, /*?string*/ relation, /*?boolean*/ forever,
                /*?string*/ id ) /*string*/ {
               __t( [cb, 'function', 'cb'], [relation, '?string', 'relation'], [forever, '?boolean', 'forever'], [id, '?string', 'id'] ); return __t( [function () {
            ...
            }, { "signature": "function(function,?string,?boolean,?string):string" } ),

            registerCallback: __w( function (/*function*/ cb, /*?boolean*/ persistent,
                /*?string*/ id ) /*string*/ {
               __t( [cb, 'function', 'cb'], [persistent, '?boolean', 'persistent'], [id, '?string', 'id'] ); return __t( [function () {
                  id = id || guid();
                  if ( persistent ) {
                     XD._forever[id] = true;
                  }
            ...
            }, { "signature": "function(function,?boolean,?string):string" } )
         };
         ...
         Event.subscribe( 'init:post', __w( function (/*object*/ options ) {
            __t( [options, 'object', 'options'] );
      ...
      __d( "sdk.Auth", ["sdk.Cookie", "copyProperties", "sdk.createIframe", "DOMWrapper", "sdk.feature", "sdk.getContextType", "guid", "sdk.Impressions", "Log", "ObservableMixin", "sdk.Runtime", "sdk.SignedRequest", "UrlMap", "sdk.URI", "sdk.XD"], function ( global, require, requireDynamic, requireLazy, module, exports, Cookie, copyProperties, createIframe, DOMWrapper, feature, getContextType, guid, Impressions, Log, ObservableMixin, Runtime, SignedRequest, UrlMap, URI, XD ) {
         ...
         function setAuthResponse(/*?object*/ authResponse, /*string*/ status ) {
            __t( [authResponse, '?object', 'authResponse'], [status, 'string', 'status'] );
         ...
         function getAuthResponse() /*?object*/ {
            return __t( [function () {
               return currentAuthResponse;
            }.apply( this, arguments ), '?object'] );
         } __w( getAuthResponse, { "signature": "function():?object" } );

         function xdResponseWrapper(/*function*/ cb, /*?object*/ authResponse,
             /*?string*/ method ) /*function*/ {
            __t( [cb, 'function', 'cb'], [authResponse, '?object', 'authResponse'], [method, '?string', 'method'] ); return __t( [function () {
               return __w( function (/*?object*/ params ) /*?object*/ {
                  __t( [params, '?object', 'params'] ); return __t( [function () {
                     var status;
         ...
         } __w( xdResponseWrapper, { "signature": "function(function,?object,?string):function" } );

         function fetchLoginStatus(/*function*/ fn ) {
            __t( [fn, 'function', 'fn'] );
            ...
            var url = URI( UrlMap.resolve( 'www', true ) + '/connect/ping' )
              .setQueryData( {
                 ...
                 redirect_uri: XD.handler( __w( function (/*object*/ response ) {
                    __t( [response, 'object', 'response'] );
         ...
         var loadState;
         function getLoginStatus(/*?function*/ cb, /*?boolean*/ force ) {
            __t( [cb, '?function', 'cb'], [force, '?boolean', 'force'] );
            ...
            var lsCb = __w( function (/*?object*/ response ) {
               __t( [response, '?object', 'response'] );
      ...
      __d( "toArray", ["invariant"], function ( global, require, requireDynamic, requireLazy, module, exports, invariant ) {
         ...
         function toArray( obj ) {
            __t( [obj, 'object|function|filelist', 'obj'] ); return __t( [function () {
         ...
         } __w( toArray, { "signature": "function(object|function|filelist):array" } );
      ...
      __d( "createArrayFrom", ["toArray"], function ( global, require, requireDynamic, requireLazy, module, exports, toArray ) {
         ...
         } __w( hasArrayNature, { "signature": "function():boolean" } );
         ...
         } __w( createArrayFrom, { "signature": "function():array" } );
      ...
      __d( "sdk.DOM", ["Assert", "createArrayFrom", "sdk.domReady", "UserAgent"], function ( global, require, requireDynamic, requireLazy, module, exports, Assert, createArrayFrom, domReady, UserAgent ) {
         ...
         function getAttr(/*DOMElement*/ dom, /*string*/ name ) /*string?*/ {
            __t( [dom, 'DOMElement', 'dom'], [name, 'string', 'name'] ); return __t( [function () {
               var attribute = (
         ...
         } __w( getAttr, { "signature": "function(DOMElement,string):string?" } );

         function getBoolAttr(/*DOMElement*/ dom, /*string*/ name ) /*boolean?*/ {
            __t( [dom, 'DOMElement', 'dom'], [name, 'string', 'name'] ); return __t( [function () {
         ...
         } __w( getBoolAttr, { "signature": "function(DOMElement,string):boolean?" } );

         function getProp(/*DOMElement*/ dom, /*string*/ name ) /*string*/ {
            __t( [dom, 'DOMElement', 'dom'], [name, 'string', 'name'] ); return __t( [function () {
         ...
         } __w( getProp, { "signature": "function(DOMElement,string):string" } );

         function html(/*DOMElement*/ dom, /*string*/ content ) {
            __t( [dom, 'DOMElement', 'dom'], [content, 'string', 'content'] );
            Assert.isTruthy( dom, 'element not specified' );
         ...
         function hasClass(/*DOMElement*/ dom, /*string*/ className ) /*boolean*/ {
            __t( [dom, 'DOMElement', 'dom'], [className, 'string', 'className'] ); return __t( [function () {
               Assert.isTruthy( dom, 'element not specified' );
         ...
         } __w( hasClass, { "signature": "function(DOMElement,string):boolean" } );


         function addClass(/*DOMElement*/ dom, /*string*/ className ) {
            __t( [dom, 'DOMElement', 'dom'], [className, 'string', 'className'] );
            Assert.isTruthy( dom, 'element not specified' );
            Assert.isString( className );
         ...
         function removeClass(/*DOMElement*/ dom, /*string*/ className ) {
            __t( [dom, 'DOMElement', 'dom'], [className, 'string', 'className'] );
            Assert.isTruthy( dom, 'element not specified' );
            Assert.isString( className );
         ...
         function getByClass(/*string*/ className, dom, tagName ) /*array<DOMElement>*/ {
            __t( [className, 'string', 'className'] ); return __t( [function () {
               Assert.isString( className );
               ...
               return els;
            }.apply( this, arguments ), 'array<DOMElement>'] );
         } __w( getByClass, { "signature": "function(string):array<DOMElement>" } );


         function getStyle(/*DOMElement*/ dom, /*string*/ styleProp ) /*string*/ {
            __t( [dom, 'DOMElement', 'dom'], [styleProp, 'string', 'styleProp'] ); return __t( [function () {
               Assert.isTruthy( dom, 'element not specified' );
         ...
         } __w( getStyle, { "signature": "function(DOMElement,string):string" } );


         function setStyle(/*DOMElement*/ dom, /*string*/ styleProp, value ) {
            __t( [dom, 'DOMElement', 'dom'], [styleProp, 'string', 'styleProp'] );
            Assert.isTruthy( dom, 'element not specified' );
            Assert.isString( styleProp );
         ...
         function addCssRules(/*string*/ styles, /*array<string>*/ names ) {
            __t( [styles, 'string', 'styles'], [names, 'array<string>', 'names'] );
         ...
         function getViewportInfo() /*object*/ {
            return __t( [function () {
         ...
         } __w( getViewportInfo, { "signature": "function():object" } );


         function getPosition(/*DOMElement*/ node ) /*object*/ {
            __t( [node, 'DOMElement', 'node'] ); return __t( [function () {
         ...
         } __w( getPosition, { "signature": "function(DOMElement):object" } );
      ...
      __d( "sdk.ErrorHandling", ["sdk.feature", "ManagedError", "sdk.Runtime", "sdk.Scribe", "UserAgent", "wrapFunction"], function ( global, require, requireDynamic, requireLazy, module, exports, feature, ManagedError, Runtime, Scribe, UserAgent, wrapFunction ) {
         ...
         function normalizeError( err ) /*object*/ {
            return __t( [function () {
               var info = {
         ...
         } __w( normalizeError, { "signature": "function():object" } );

         function guard(/*function*/ func, /*string?*/ entry ) /*function*/ {
            __t( [func, 'function', 'func'], [entry, '?string', 'entry'] ); return __t( [function () {
               return function () {
         ...
         } __w( guard, { "signature": "function(function,?string):function" } );

         function unguard(/*function*/ func ) /*function*/ {
            __t( [func, 'function', 'func'] ); return __t( [function () {
               if ( !func.__wrapper ) {
         ...
         } __w( unguard, { "signature": "function(function):function" } );
      ...
      __d( "sdk.Insights", ["sdk.Impressions"], function ( global, require, requireDynamic, requireLazy, module, exports, Impressions ) {
         ...
         var Insights = {
            ...
            log: __w( function (/*string*/ type, /*string*/ category, /*string*/ content ) {
               __t( [type, 'string', 'type'], [category, 'string', 'category'], [content, 'string', 'content'] );
               var payload = {
                  source: 'jssdk',
                  type: type,
                  category: category,
      ...
      __d( "FB", ["sdk.Auth", "copyProperties", "JSSDKCssConfig", "dotAccess", "sdk.domReady", "sdk.DOM", "sdk.ErrorHandling", "sdk.Content", "DOMWrapper", "GlobalCallback", "sdk.Insights", "Log", "sdk.Runtime", "sdk.Scribe", "JSSDKConfig"], function ( global, require, requireDynamic, requireLazy, module, exports, Auth, copyProperties, CssConfig, dotAccess, domReady, DOM, ErrorHandling, Content, DOMWrapper, GlobalCallback, Insights, Log, Runtime, Scribe, SDKConfig ) {
         ...
         Runtime.subscribe( 'AccessToken.change', __w( function (/*?string*/ value ) {
            __t( [value, '?string', 'value'] );
         ...
         if ( dotAccess( SDKConfig, 'api.whitelist.length' ) ) {
            apiWhitelist = {};
            ES5( SDKConfig.api.whitelist, 'forEach', true, __w( function (/*string*/ key ) {
               __t( [key, 'string', 'key'] );
               apiWhitelist[key] = 1;
            }, { "signature": "function(string)" } ) );
         }
         ...
         function protect(/*function*/ fn, /*string*/ accessor, /*string*/ key,
            ...
            __t( [fn, 'function', 'fn'], [accessor, 'string', 'accessor'], [key, 'string', 'key'], [context, 'object', 'context'] ); return __t( [function () {
               var exportMode;
               if ( /^_/.test( key ) ) {
                  exportMode = 'hide';
         ...
         } __w( protect, { "signature": "function(function,string,string,object):?function" } );


         function provide(/*string*/ name, /*object*/ source ) {
            __t( [name, 'string', 'name'], [source, 'object', 'source'] );
            var externalTarget = name
              ? dotAccess( externalInterface, name, true )
              : externalInterface;

            ES5( ES5( 'Object', 'keys', false, source ), 'forEach', true, __w( function (/*string*/ key ) {
               __t( [key, 'string', 'key'] );
         ...
         Runtime.setSecure(( __w( function () /*?boolean*/ {
            return __t( [function () {
      ...
      __d( "CORSRequest", ["wrapFunction", "QueryString"], function ( global, require, requireDynamic, requireLazy, module, exports, wrapFunction, QueryString ) {
         ...
         function createCORSRequest(/*string*/ method, /*string*/ url ) /*?object*/ {
            __t( [method, 'string', 'method'], [url, 'string', 'url'] ); return __t( [function () {
               ...
               var wrapper = {
                  send: __w( function (/*string*/ data ) {
                     __t( [data, 'string', 'data'] );
                     xhr.send( data );
                  }, { "signature": "function(string)" } )
               };
         ...
         } __w( createCORSRequest, { "signature": "function(string,string):?object" } );

         function execute(/*string*/ url, /*string*/ method, /*object*/ params,
             /*function*/ cb ) /*boolean*/ {
            __t( [url, 'string', 'url'], [method, 'string', 'method'], [params, 'object', 'params'], [cb, 'function', 'cb'] ); return __t( [function () {
         ...
         } __w( execute, { "signature": "function(string,string,object,function):boolean" } );
      ...
      __d( "FlashRequest", ["DOMWrapper", "Flash", "GlobalCallback", "QueryString", "Queue"], function ( global, require, requireDynamic, requireLazy, module, exports, DOMWrapper, Flash, GlobalCallback, QueryString, Queue ) {
         ...
         function initFlash() {
            ...
            var initCallback = GlobalCallback.create( function () {
               flashQueue.start( __w( function (/*object*/ item ) {
                  __t( [item, 'object', 'item'] );
                  var id = swf.execute(
                    item.method,
                    item.url,
                    item.body );
            ...
            var requestCallback = GlobalCallback.create( __w( function (/*number*/ id,
                /*number*/ status, /*string*/ response ) {
               __t( [id, 'number', 'id'], [status, 'number', 'status'], [response, 'string', 'response'] );
               var data;
               try {
         ...
         var FlashRequest = {
            setSwfUrl: __w( function (/*string*/ swf_url ) {
               __t( [swf_url, 'string', 'swf_url'] );
               swfUrl = swf_url;
            }, { "signature": "function(string)" } ),
            execute: execute
         };
      ...
      __d( "flattenObject", [], function ( global, require, requireDynamic, requireLazy, module, exports ) {
         ...
         function flattenObject(/*object*/ obj ) /*object*/ {
            __t( [obj, 'object', 'obj'] ); return __t( [function () {
               var flat = {};
               for ( var key in obj ) {
         ...
         } __w( flattenObject, { "signature": "function(object):object" } );
      ...
      __d( "ApiClient", ["ArgumentError", "Assert", "copyProperties", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "sprintf", "sdk.URI", "UrlMap", "ApiClientConfig"], function ( global, require, requireDynamic, requireLazy, module, exports, ArgumentError, Assert, copyProperties, CORSRequest, FlashRequest, flattenObject, JSONPRequest, Log, ObservableMixin, sprintf, URI, UrlMap, ApiClientConfig ) {
         ...
         function request(/*string*/ url, /*string*/ method, /*object*/ params,
             /*function*/ cb ) {
            __t( [url, 'string', 'url'], [method, 'string', 'method'], [params, 'object', 'params'], [cb, 'function', 'cb'] );
            if ( defaultParams ) {
         ...
         function inspect(/*?function*/ callback, /*string*/ endpoint, /*string*/ method,
            ...
            __t( [callback, '?function', 'callback'], [endpoint, 'string', 'endpoint'], [method, 'string', 'method'], [params, 'object', 'params'] );
         ...
         function requestUsingGraph(/*string*/ path ) {
            __t( [path, 'string', 'path'] );
         ...
         function requestUsingRest(/*object*/ params, /*?function*/ cb ) {
            __t( [params, 'object', 'params'], [cb, '?function', 'cb'] );
         ...
         var ApiClient = copyProperties( new ObservableMixin(), {
            setAccessToken: __w( function (/*?string*/ access_token ) {
               __t( [access_token, '?string', 'access_token'] );
               accessToken = access_token;
            }, { "signature": "function(?string)" } ),
            setClientID: __w( function (/*?string*/ client_id ) {
               __t( [client_id, '?string', 'client_id'] );
               clientID = client_id;
            }, { "signature": "function(?string)" } ),
            setDefaultParams: __w( function (/*?object*/ default_params ) {
               __t( [default_params, '?object', 'default_params'] );
      ...
      __d( "sdk.PlatformVersioning", ["sdk.Runtime", "ManagedError"], function ( global, require, requireDynamic, requireLazy, module, exports, Runtime, ManagedError ) {
         ...
         var PlatformVersioning = {
            ...
            assertValidVersion: __w( function (/*string*/ version ) {
               __t( [version, 'string', 'version'] );
      ...
      __d( "sdk.api", ["ApiClient", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.URI"], function ( global, require, requireDynamic, requireLazy, module, exports, ApiClient, PlatformVersioning, Runtime, URI ) {
         ...
         Runtime.subscribe( 'ClientID.change', __w( function (/*?string*/ value ) {
            __t( [value, '?string', 'value'] );
         ...
         ApiClient.subscribe( 'request.complete', __w( function (/*string*/ endpoint,
             /*string*/ method, /*object*/ params, response ) {
            __t( [endpoint, 'string', 'endpoint'], [method, 'string', 'method'], [params, 'object', 'params'] );
      ...
      __d( "sdk.Canvas.Environment", ["sdk.RPC"], function ( global, require, requireDynamic, requireLazy, module, exports, RPC ) {
         ...
         function getPageInfo(/*function*/ appCallback ) {
            __t( [appCallback, 'function', 'appCallback'] );
            RPC.remote.getPageInfo( __w( function (/*object*/ response ) {
               __t( [response, 'object', 'response'] );
               appCallback( response.result );
            }, { "signature": "function(object)" } ) );
         } __w( getPageInfo, { "signature": "function(function)" } );

         function scrollTo(/*number?*/ x, /*number?*/ y ) {
            __t( [x, '?number', 'x'], [y, '?number', 'y'] );
      ...
      __d( "sdk.Intl", ["Log"], function ( global, require, requireDynamic, requireLazy, module, exports, Log ) {
         ...
         function _endsInPunct(/*string?*/ str ) /*boolean*/ {
            __t( [str, '?string', 'str'] ); return __t( [function () {
         ...
         } __w( _endsInPunct, { "signature": "function(?string):boolean" } );


         function _substituteTokens(/*string*/ str, /*object?*/ args ) /*string*/ {
            __t( [str, 'string', 'str'], [args, '?object', 'args'] ); return __t( [function () {
         ...
         } __w( _substituteTokens, { "signature": "function(string,?object):string" } );
      ...
      __d( "sdk.Dialog", ["sdk.Canvas.Environment", "sdk.Content", "sdk.DOM", "DOMEventListener", "sdk.Intl", "ObservableMixin", "sdk.Runtime", "Type", "UserAgent", "sdk.feature"], function ( global, require, requireDynamic, requireLazy, module, exports, CanvasEnvironment, Content, DOM, DOMEventListener, Intl, ObservableMixin, Runtime, Type, UserAgent, feature ) {
         ...
         var isTablet = __w( function () /*boolean*/ {
            return __t( [function () {
               var result;
         ...
         } __w( getMobileSize, { "signature": "function():?object" } );


         var SdkDialog = Type.extend( {
            constructor: __w( function SdkDialog(/*string*/ id, /*string*/ display ) {
               __t( [id, 'string', 'id'], [display, 'string', 'display'] );
               this.parent();
               this.id = id;
            ...
            trackEvent: __w( function (/*string*/ name, /*?number*/ time ) /*SdkDialog*/ {
               __t( [name, 'string', 'name'], [time, '?number', 'time'] ); return __t( [function () {
                  if ( this._e2e[name] ) {
                     return this;
                  }
                  ...
                  return this;
               }.apply( this, arguments ), 'SdkDialog'] );
            }, { "signature": "function(string,?number):SdkDialog" } ),

            trackEvents: __w( function (/*string|object*/ events ) /*SdkDialog*/ {
               __t( [events, 'string|object', 'events'] ); return __t( [function () {
            ...
            }, { "signature": "function(string|object):SdkDialog" } )
         }, ObservableMixin );

         var Dialog = {
            newInstance: __w( function (/*string*/ id, /*string*/ display ) /*SdkDialog*/ {
               __t( [id, 'string', 'id'], [display, 'string', 'display'] ); return __t( [function () {
                  return new SdkDialog( id, display );
               }.apply( this, arguments ), 'SdkDialog'] );
            }, { "signature": "function(string,string):SdkDialog" } ),
            ...
            get: __w( function (/*string*/ id ) /*SdkDialog*/ {
               __t( [id, 'string', 'id'] ); return __t( [function () {
                  return Dialog._dialogs[id];
               }.apply( this, arguments ), 'SdkDialog'] );
            }, { "signature": "function(string):SdkDialog" } ),



            _findRoot: __w( function (/*DOMElement*/ node ) /*DOMElement*/ {
               __t( [node, 'DOMElement', 'node'] ); return __t( [function () {
                  while ( node ) {
            ...
            }, { "signature": "function(DOMElement):DOMElement" } ),

            _createWWWLoader: __w( function (/*number*/ width ) /*DOMElement*/ {
               __t( [width, 'number', 'width'] ); return __t( [function () {
            ...
            }, { "signature": "function(number):DOMElement" } ),

            _createMobileLoader: __w( function () /*DOMElement*/ {
               return __t( [function () {
            ...
            showLoader: __w( function (/*?function*/ cb, /*number*/ width ) {
               __t( [cb, '?function', 'cb'], [width, 'number', 'width'] );
            ...
            _makeActive: __w( function (/*DOMElement*/ el ) {
               __t( [el, 'DOMElement', 'el'] );
            ...
            _removeStacked: __w( function (/*DOMElement*/ dialog ) {
               __t( [dialog, 'DOMElement', 'dialog'] );
            ...
            _centerActive: __w( function (/*?object*/ pageInfo ) {
               __t( [pageInfo, '?object', 'pageInfo'] );
            ...
            getDefaultSize: __w( function () /*object*/ {
               return __t( [function () {
                  if ( UserAgent.mobile() ) {
                     var size = getMobileSize();
            ...
            create: __w( function (/*object*/ opts ) /*DOMElement*/ {
               __t( [opts, 'object', 'opts'] ); return __t( [function () {
                  opts = opts || {};
                  ...
                  if ( UserAgent.ie() ) {
                     ...
                     ES5( ['vert_left',
                       ...
                       'top_right',
                       'bottom_left',
                       'bottom_right'], 'forEach', true, __w( function (/*string*/ name ) {
                          __t( [name, 'string', 'name'] );
            ...
            }, { "signature": "function(object):DOMElement" } ),


            show: __w( function (/*DOMElement*/ dialog ) {
               __t( [dialog, 'DOMElement', 'dialog'] );
            ...
            hide: __w( function (/*DOMElement*/ dialog ) {
               __t( [dialog, 'DOMElement', 'dialog'] );
               var root = Dialog._findRoot( dialog );
               Dialog._hideLoader();
            ...
            remove: __w( function (/*DOMElement*/ dialog ) {
               __t( [dialog, 'DOMElement', 'dialog'] );
            ...
            isActive: __w( function (/*DOMElement*/ node ) /*boolean*/ {
               __t( [node, 'DOMElement', 'node'] ); return __t( [function () {
                  var root = Dialog._findRoot( node );
                  return root && root === Dialog._active;
               }.apply( this, arguments ), 'boolean'] );
            }, { "signature": "function(DOMElement):boolean" } )
         ...
         var Frictionless = {
            ...
            _updateRecipients: function () {
               ...
               api( '/me/apprequestformerrecipients', function ( response ) {
                  ...
                  ES5( response.data, 'forEach', true, __w( function (/*object*/ recipient ) {
                     __t( [recipient, 'object', 'recipient'] );
            ...
            init: function () {
               ...
               Auth.getLoginStatus( __w( function (/*object*/ response ) {
                  __t( [response, 'object', 'response'] );
                  if ( response.status == 'connected' ) {
                     Frictionless._updateRecipients();
                  }
               }, { "signature": "function(object)" } ) );
               Event.subscribe( 'auth.login', __w( function (/*object*/ login ) {
                  __t( [login, 'object', 'login'] );
            ...
            _processRequestResponse: __w( function (/*function*/ cb, /*boolean? */hidden )
               /*function*/ {
               __t( [cb, 'function', 'cb'] ); return __t( [function () {
                  return __w( function (/*object?*/ params ) {
                     __t( [params, '?object', 'params'] );
            ...
            isAllowed: __w( function ( user_ids ) /*boolean*/ {
               return __t( [function () {
                  if ( !user_ids ) {
                     return false;
                  }
                  ...
                  ES5( user_ids, 'forEach', true, __w( function (/*string*/ user_id ) {
                     __t( [user_id, 'string', 'user_id'] );
      ...
      __d( "insertIframe", ["guid", "GlobalCallback"], function ( global, require, requireDynamic, requireLazy, module, exports, guid, GlobalCallback ) {
         ...
         function insertIframe(/*object*/ opts ) {
            __t( [opts, 'object', 'opts'] );
      ...
      __d( "sdk.Native", ["copyProperties", "Log", "UserAgent"], function ( global, require, requireDynamic, requireLazy, module, exports, copyProperties, Log, UserAgent ) {
         ...
         var Native = {
            ...
            onready: __w( function (/*function*/ func ) {
               __t( [func, 'function', 'func'] );
      ...
      __d( "resolveURI", [], function ( global, require, requireDynamic, requireLazy, module, exports ) {
         function resolveURI(/*string?*/ uri ) /*string*/ {
            __t( [uri, '?string', 'uri'] ); return __t( [function () {
               if ( !uri ) {
         ...
         } __w( resolveURI, { "signature": "function(?string):string" } );
      ...
      __d( "sdk.UIServer", ["sdk.Auth", "sdk.Content", "createObjectFrom", "copyProperties", "sdk.Dialog", "sdk.DOM", "sdk.Event", "flattenObject", "sdk.Frictionless", "sdk.getContextType", "guid", "insertIframe", "Log", "sdk.Native", "QueryString", "resolveURI", "sdk.RPC", "sdk.Runtime", "JSSDKConfig", "UrlMap", "UserAgent", "sdk.XD"], function ( global, require, requireDynamic, requireLazy, module, exports, Auth, Content, createObjectFrom, copyProperties, Dialog, DOM, Event, flattenObject, Frictionless, getContextType, guid, insertIframe, Log, Native, QueryString, resolveURI, RPC, Runtime, SDKConfig, UrlMap, UserAgent, XD ) {
         ...
         var MobileIframeable = {
            transform: __w( function (/*object*/ call ) /*object*/ {
               __t( [call, 'object', 'call'] ); return __t( [function () {
            ...
            getXdRelation: __w( function (/*object*/ params ) /*string*/ {
               __t( [params, 'object', 'params'] ); return __t( [function () {
         ...
         var Methods = {
            ...
            'permissions.oauth': {
               url: 'dialog/oauth',
               size: {
                  width: ( UserAgent.mobile() ? null : 475 ),
         ...
         var UIServer = {
            ...
            genericTransform: __w( function (/*object*/ call ) /*object*/ {
               __t( [call, 'object', 'call'] ); return __t( [function () {
            ...
            prepareCall: __w( function (/*object*/ params, /*function*/ cb ) /*?object*/ {
               __t( [params, 'object', 'params'], [cb, 'function', 'cb'] ); return __t( [function () {
                  var
            ...
            }, { "signature": "function(object,function):?object" } ),

            prepareParams: __w( function (/*object*/ call ) /*object*/ {
               __t( [call, 'object', 'call'] ); return __t( [function () {
            ...
            urlTooLongForIE: __w( function (/*string*/ fullURL ) /*boolean*/ {
               __t( [fullURL, 'string', 'fullURL'] ); return __t( [function () {
                  return fullURL.length > 2000;
               }.apply( this, arguments ), 'boolean'] );
            }, { "signature": "function(string):boolean" } ),


            getDisplayMode: __w( function (/*object*/ method, /*object*/ params ) /*string*/ {
               __t( [method, 'object', 'method'], [params, 'object', 'params'] ); return __t( [function () {
            ...
            }, { "signature": "function(object,object):string" } ),
            ...
            popup: __w( function (/*object*/ call ) {
               __t( [call, 'object', 'call'] );
            ...
            setLoadedNode: __w( function (/*object*/ call, node, /*?string*/ type ) {
               __t( [call, 'object', 'call'], [type, '?string', 'type'] );
            ...
            hidden: __w( function (/*object*/ call ) {
               __t( [call, 'object', 'call'] );
            ...
            iframe: __w( function (/*object*/ call ) {
               __t( [call, 'object', 'call'] );
            ...
            touch: __w( function (/*object*/ call ) {
               __t( [call, 'object', 'call'] );
            ...
            async: __w( function (/*object*/ call ) {
               __t( [call, 'object', 'call'] );
               call.params.redirect_uri = location.protocol + '//' +
                 location.host + location.pathname;
               delete call.params.access_token;

               RPC.remote.showDialog( call.params, __w( function (/*object*/ response ) {
                  __t( [response, 'object', 'response'] );
            ...
            _insertIframe: __w( function (/*object*/ call ) {
               __t( [call, 'object', 'call'] );


               // from the _frames nodes, and we won't add the node back in.
               UIServer._loadedNodes[call.id] = false;
               var activate = __w( function (/*DOMElement*/ node ) {
                  __t( [node, 'DOMElement', 'node'] );
               ...
               if ( call.post ) {
                  insertIframe( {
                     ...
                     id: call.id,
                     onInsert: activate,
                     onload: __w( function (/*DOMElement*/ node ) {
                        __t( [node, 'DOMElement', 'node'] );
                        Content.submitToTarget( {
                           url: call.url,
                           target: node.name,
            ...
            _handleResizeMessage: __w( function (/*string*/ frame, /*object*/ data ) {
               __t( [frame, 'string', 'frame'], [data, 'object', 'data'] );
            ...
            _triggerDefault: __w( function (/*string*/ id ) {
               __t( [id, 'string', 'id'] );
               UIServer._xdRecv(
                 { frame: id },
            ...
            _xdChannelHandler: __w( function (/*string*/ frame, /*string*/ relation )
               /*string*/ {
               __t( [frame, 'string', 'frame'], [relation, 'string', 'relation'] ); return __t( [function () {
                  return XD.handler( __w( function (/*object*/ data ) {
                     __t( [data, 'object', 'data'] );
                     var node = UIServer.getLoadedNode( frame );
                     if ( !node ) {
                        return;
                     }
            ...
            _xdNextHandler: __w( function (/*function*/ cb, /*string*/ frame,
                 /*string*/ relation, /*boolean*/ isDefault ) /*string*/ {
               __t( [cb, 'function', 'cb'], [frame, 'string', 'frame'], [relation, 'string', 'relation'], [isDefault, 'boolean', 'isDefault'] ); return __t( [function () {
                  if ( isDefault ) {
            ...
            }, { "signature": "function(function,string,string,boolean):string" } ),


            _xdRecv: __w( function (/*object*/ data, /*function*/ cb ) {
               __t( [data, 'object', 'data'], [cb, 'function', 'cb'] );
            ...
            _xdResult: __w( function (/*function*/ cb, /*string*/ frame, /*string*/ target,
                /*boolean*/ isDefault ) /*string*/ {
               __t( [cb, 'function', 'cb'], [frame, 'string', 'frame'], [target, 'string', 'target'], [isDefault, 'boolean', 'isDefault'] ); return __t( [function () {
                  return (
            ...
            xdHandler: __w( function (/*function*/ cb, /*string*/ frame, /*string*/ target,
                /*?object*/ authResponse, /*string*/ method ) /*string*/ {
               __t( [cb, 'function', 'cb'], [frame, 'string', 'frame'], [target, 'string', 'target'], [authResponse, '?object', 'authResponse'], [method, 'string', 'method'] ); return __t( [function () {
            ...
            }, { "signature": "function(function,string,string,?object,string):string" } )
      ...
      __d( "sdk.ui", ["Assert", "sdk.Impressions", "Log", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UIServer", "copyProperties", "sdk.feature"], function ( global, require, requireDynamic, requireLazy, module, exports, Assert, Impressions, Log, PlatformVersioning, Runtime, UIServer, copyProperties, feature ) {
         ...
         function ui(/*object*/ params, /*?function*/ cb ) /*?object*/ {
            __t( [params, 'object', 'params'], [cb, '?function', 'cb'] ); return __t( [function () {
               Assert.isObject( params );
               ...
               if ( enableE2E ) {
                  call.dialog.subscribe( 'e2e:end', __w( function (/*object*/ events ) {
                     __t( [events, 'object', 'events'] );
         ...
         } __w( ui, { "signature": "function(object,?function):?object" } );
      ...
      __d( "legacy:fb.auth", ["sdk.Auth", "sdk.Cookie", "copyProperties", "sdk.Event", "FB", "Log", "sdk.Runtime", "sdk.SignedRequest", "sdk.ui"], function ( global, require, requireDynamic, requireLazy, __DO_NOT_USE__module, __DO_NOT_USE__exports, Auth, Cookie, copyProperties, Event, FB, Log, Runtime, SignedRequest, ui ) {
         ...
         FB.provide( '', {
            ...
            getLoginStatus: __w( function () /*object?*/ {
               return __t( [function () {
                  return Auth.getLoginStatus.apply( Auth, arguments );
               }.apply( this, arguments ), '?object'] );
            }, { "signature": "function():object?" } ),

            getAuthResponse: __w( function () /*object?*/ {
               return __t( [function () {
                  return Auth.getAuthResponse();
               }.apply( this, arguments ), '?object'] );
            }, { "signature": "function():object?" } ),

            getAccessToken: __w( function () /*string?*/ {
               return __t( [function () {
                  return Runtime.getAccessToken() || null;
               }.apply( this, arguments ), '?string'] );
            }, { "signature": "function():string?" } ),

            getUserID: __w( function () /*string?*/ {
               return __t( [function () {
                  return Runtime.getUserID() || Runtime.getCookieUserID();
               }.apply( this, arguments ), '?string'] );
            }, { "signature": "function():string?" } ),

            login: __w( function (/*function?*/ cb, /*object?*/ opts ) {
               __t( [cb, '?function', 'cb'], [opts, '?object', 'opts'] );
            ...
            logout: __w( function (/*function?*/ cb ) {
               __t( [cb, '?function', 'cb'] );
      ...
      __d( "sdk.Canvas.IframeHandling", ["DOMWrapper", "sdk.RPC"], function ( global, require, requireDynamic, requireLazy, module, exports, DOMWrapper, RPC ) {
         ...
         function setSize(/*object?*/ params ) /*boolean*/ {
            __t( [params, '?object', 'params'] ); return __t( [function () {
         ...
         } __w( setSize, { "signature": "function(?object):boolean" } );
      ...
      __d( "sdk.Canvas.Navigation", ["sdk.RPC"], function ( global, require, requireDynamic, requireLazy, module, exports, RPC ) {
         ...
         function setUrlHandler(/*function*/ callback ) {
            __t( [callback, 'function', 'callback'] );
            RPC.local.navigate = __w( function (/*string*/ path ) {
               __t( [path, 'string', 'path'] );
               callback( { path: path } );
            }, { "signature": "function(string)" } );
      ...
      __d( "sdk.Canvas.Plugin", ["sdk.api", "sdk.RPC", "Log", "UserAgent", "sdk.Runtime", "createArrayFrom"], function ( global, require, requireDynamic, requireLazy, module, exports, api, RPC, Log, UserAgent, Runtime, createArrayFrom ) {
         ...
         function hideUnityElement(/*DOMElement*/ elem ) {
            __t( [elem, 'DOMElement', 'elem'] );
         ...
         function showUnityElement(/*DOMElement*/ elem ) {
            __t( [elem, 'DOMElement', 'elem'] );
         ...
         function hideFlashElement(/*DOMElement*/ elem ) {
            __t( [elem, 'DOMElement', 'elem'] );
         ...
         function showFlashElement(/*DOMElement*/ elem ) {
            __t( [elem, 'DOMElement', 'elem'] );
            elem.style.visibility = elem._old_visibility || '';
            delete elem._old_visibility;
         } __w( showFlashElement, { "signature": "function(DOMElement)" } );

         function isHideableFlashElement(/*DOMElement*/ elem ) {
            __t( [elem, 'DOMElement', 'elem'] );
         ...
         function isHideableUnityElement(/*DOMElement*/ elem ) {
            __t( [elem, 'DOMElement', 'elem'] );
            var type = elem.type ? elem.type.toLowerCase() : null;
         ...
         function hidePluginCallback(/*object*/ params ) {
            __t( [params, 'object', 'params'] );
            ...
            ES5( candidates, 'forEach', true, __w( function (/*DOMElement*/ elem ) {
               __t( [elem, 'DOMElement', 'elem'] );
         ...
         var Plugin = {
            ...
            _setHidePluginCallback: __w( function (/*?function*/ callback ) {
               __t( [callback, '?function', 'callback'] );
      ...
      __d( "sdk.Canvas.Tti", ["sdk.RPC", "sdk.Runtime"], function ( global, require, requireDynamic, requireLazy, module, exports, RPC, Runtime ) {
         ...
         function passAppTtiMessage(/*function?*/ callback, /*string*/ messageName ) {
            __t( [callback, '?function', 'callback'], [messageName, 'string', 'messageName'] );
            var params = {
               appId: Runtime.getClientID(),
            ...
            var args = [params];
            if ( callback ) {
               args.push( __w( function (/*object*/ response ) {
                  __t( [response, 'object', 'response'] );
      ...
      __d( "sdk.Canvas.Prefetcher", ["sdk.api", "createArrayFrom", "JSSDKCanvasPrefetcherConfig", "sdk.Runtime"], function ( global, require, requireDynamic, requireLazy, module, exports, api, createArrayFrom, CanvasPrefetcherConfig, Runtime ) {
         ...
         function sample() {
            ...
            if ( collectionMode == COLLECT.AUTOMATIC ) {
               ES5( ES5( 'Object', 'keys', false, resourceFieldsByTag ), 'forEach', true, __w( function (/*string*/ tagName ) {
                  __t( [tagName, 'string', 'tagName'] );
                  var propertyName = resourceFieldsByTag[tagName];
                  ES5( createArrayFrom( document.getElementsByTagName( tagName ) ), 'forEach', true, __w( function (/*DOMElement*/ tag ) {
                     __t( [tag, 'DOMElement', 'tag'] );
                     if ( tag[propertyName] ) {
         ...
         function setCollectionMode(/*number*/ mode ) {
            __t( [mode, 'number', 'mode'] );
            collectionMode = mode;
         } __w( setCollectionMode, { "signature": "function(number)" } );


         function addStaticResource(/*string*/ url ) {
            __t( [url, 'string', 'url'] );
            links.push( url );
      ...
      __d( "legacy:fb.canvas.presence", ["sdk.RPC", "sdk.Event"], function ( global, require, requireDynamic, requireLazy, __DO_NOT_USE__module, __DO_NOT_USE__exports, RPC, Event ) {
         ...
         function subscriptionAdded(/*string*/ name, /*array*/ callbacks ) {
            __t( [name, 'string', 'name'], [callbacks, 'array', 'callbacks'] );
         ...
         } __w( subscriptionAdded, { "signature": "function(string,array)" } );

         function subscriptionRemoved(/*string*/ name, /*array*/ callbacks ) {
            __t( [name, 'string', 'name'], [callbacks, 'array', 'callbacks'] );
            if ( name != 'canvas.friendsOnlineUpdated' ) {
               return;
            }
         ...
         } __w( subscriptionRemoved, { "signature": "function(string,array)" } );
      ...
      __d( "sdk.init", ["sdk.Cookie", "sdk.ErrorHandling", "sdk.Event", "Log", "ManagedError", "sdk.PlatformVersioning", "QueryString", "sdk.Runtime", "sdk.URI", "copyProperties", "createArrayFrom"], function ( global, require, requireDynamic, requireLazy, module, exports, Cookie, ErrorHandling, Event, Log, ManagedError, PlatformVersioning, QueryString, Runtime, URI, copyProperties, createArrayFrom ) {
         ...
         function parseAppId(/*string|number*/ appId ) /*?string*/ {
            __t( [appId, 'string|number', 'appId'] ); return __t( [function () {
               var looksValid =
         ...
         } __w( parseAppId, { "signature": "function(string|number):?string" } );


         function init(/*object|number|string*/ options ) {
            __t( [options, 'object|number|string', 'options'] );
      ...
      __d( "legacy:fb.pay", ["copyProperties", "sdk.Runtime", "sdk.UIServer", "sdk.XD", "FB"], function ( global, require, requireDynamic, requireLazy, __DO_NOT_USE__module, __DO_NOT_USE__exports, copyProperties, Runtime, UIServer, XD ) {
         ...
         var callbackWrapper = __w( function (/*function*/ callback ) /*function*/ {
            __t( [callback, 'function', 'callback'] ); return __t( [function () {
               return __w( function (/*object?*/ msg ) {
                  __t( [msg, '?object', 'msg'] );
         ...
         copyProperties( UIServer.Methods, {
            'pay.prompt': {
               transform: __w( function (/*object*/ call ) {
                  __t( [call, 'object', 'call'] );
      ...
      __d( "XFBML", ["Assert", "copyProperties", "createArrayFrom", "sdk.DOM", "sdk.feature", "sdk.Impressions", "Log", "ObservableMixin", "runOnce", "UserAgent"], function ( global, require, requireDynamic, requireLazy, module, exports, Assert, copyProperties, createArrayFrom, DOM, feature, Impressions, Log, ObservableMixin, runOnce, UserAgent ) {
         ...
         function propStr( object, /*string*/ property ) /*string*/ {
            __t( [property, 'string', 'property'] ); return __t( [function () {
               return object[property] + '';
            }.apply( this, arguments ), 'string'] );
         } __w( propStr, { "signature": "function(string):string" } );

         function nodeNameIE(/*DOMElement*/ element ) /*string*/ {
            __t( [element, 'DOMElement', 'element'] ); return __t( [function () {
         ...
         } __w( nodeNameIE, { "signature": "function(DOMElement):string" } );

         function xfbmlInfo(/*DOMElement*/ element ) /*?object*/ {
            __t( [element, 'DOMElement', 'element'] ); return __t( [function () {
               return xfbml[propStr( element, 'nodeName' ).toLowerCase()]
                 || xfbml[nodeNameIE( element ).toLowerCase()];
            }.apply( this, arguments ), '?object'] );
         } __w( xfbmlInfo, { "signature": "function(DOMElement):?object" } );

         function html5Info(/*DOMElement*/ element ) /*?object*/ {
            __t( [element, 'DOMElement', 'element'] ); return __t( [function () {
         ...
         } __w( html5Info, { "signature": "function(DOMElement):?object" } );

         function attr(/*DOMElement*/ element ) /*object*/ {
            __t( [element, 'DOMElement', 'element'] ); return __t( [function () {
               var attrs = {};
         ...
         } __w( attr, { "signature": "function(DOMElement):object" } );

         function convertSyntax(
           /*DOMElement*/ element, /*string*/ ns, /*string*/ ln ) /*DOMElement*/ {
            __t( [element, 'DOMElement', 'element'], [ns, 'string', 'ns'], [ln, 'string', 'ln'] ); return __t( [function () {
         ...
         } __w( convertSyntax, { "signature": "function(DOMElement,string,string):DOMElement" } );

         function parse(/*DOMElement*/ dom, /*function*/ callback, /*boolean*/ reparse ) {
            __t( [dom, 'DOMElement', 'dom'], [callback, 'function', 'callback'], [reparse, 'boolean', 'reparse'] );
            Assert.isTrue(
         ...
         copyProperties( XFBML, {
            ...
            registerTag: __w( function (/*object*/ info ) {
               __t( [info, 'object', 'info'] );
            ...
            parse: __w( function (/*?DOMElement*/ dom, /*?function*/ cb ) {
               __t( [dom, '?DOMElement', 'dom'], [cb, '?function', 'cb'] );
         ...
         if ( feature( 'log_tag_count' ) ) {
            var logTagCount = __w( function (/*number*/ parseCount, /*number*/ numTags ) {
               __t( [parseCount, 'number', 'parseCount'], [numTags, 'number', 'numTags'] );
      ...
      __d( "PluginPipe", ["sdk.Content", "copyProperties", "sdk.feature", "guid", "insertIframe", "Miny", "ObservableMixin", "JSSDKPluginPipeConfig", "sdk.Runtime", "UrlMap", "UserAgent", "XFBML"], function ( global, require, requireDynamic, requireLazy, module, exports, Content, copyProperties, feature, guid, insertIframe, Miny, ObservableMixin, PluginPipeConfig, Runtime, UrlMap, UserAgent, XFBML ) {
         ...
         } __w( isEnabled, { "signature": "function():boolean" } );
         ...
         function insertPlugins() {
            ...
            if ( q.length <= threshold ) {
               ES5( q, 'forEach', true, __w( function (/*object*/ plugin ) {
                  __t( [plugin, 'object', 'plugin'] );
         ...
         function insertPipe(/*array<object>*/ plugins ) {
            __t( [plugins, 'array<object>', 'plugins'] );
            var root = document.createElement( 'span' );
            Content.appendHidden( root );

            var params = {};
            ES5( plugins, 'forEach', true, __w( function (/*object*/ plugin ) {
               __t( [plugin, 'object', 'plugin'] );
         ...
         copyProperties( PluginPipe, {
            add: __w( function (/*object*/ plugin ) /*boolean*/ {
               __t( [plugin, 'object', 'plugin'] ); return __t( [function () {
      ...
      __d( "IframePlugin", ["sdk.Auth", "sdk.DOM", "sdk.Event", "Log", "ObservableMixin", "sdk.PlatformVersioning", "PluginPipe", "QueryString", "sdk.Runtime", "Type", "sdk.URI", "UrlMap", "UserAgent", "sdk.XD", "copyProperties", "sdk.createIframe", "guid", "resolveURI"], function ( global, require, requireDynamic, requireLazy, module, exports, Auth, DOM, Event, Log, ObservableMixin, PlatformVersioning, PluginPipe, QueryString, Runtime, Type, URI, UrlMap, UserAgent, XD, copyProperties, createIframe, guid, resolveURI ) {
         ...
         function resize(/*DOMElement*/ elem, /*?number*/ width, /*?number*/ height ) {
            __t( [elem, 'DOMElement', 'elem'], [width, '?number', 'width'], [height, '?number', 'height'] );
            if ( width || width === 0 ) {
         ...
         function resizeBubbler(/*?string*/ pluginID ) /*function*/ {
            __t( [pluginID, '?string', 'pluginID'] ); return __t( [function () {
               return __w( function (/*object*/ msg ) {
                  __t( [msg, 'object', 'msg'] );
         ...
         } __w( resizeBubbler, { "signature": "function(?string):function" } );

         var types = {
            // TODO: Move the 'bool' and 'px' parsing to the server?
            string: __w( function (/*?string*/ value ) /*?string*/ {
               __t( [value, '?string', 'value'] ); return __t( [function () {
                  return value;
               }.apply( this, arguments ), '?string'] );
            }, { "signature": "function(?string):?string" } ),
            bool: __w( function (/*?string*/ value ) /*?boolean*/ {
               __t( [value, '?string', 'value'] ); return __t( [function () {
                  return value ? ( /^(?:true|1|yes|on)$/i ).test( value ) : undefined;
               }.apply( this, arguments ), '?boolean'] );
            }, { "signature": "function(?string):?boolean" } ),
            url: __w( function (/*?string*/ value ) /*?string*/ {
               __t( [value, '?string', 'value'] ); return __t( [function () {
                  return resolveURI( value );
               }.apply( this, arguments ), '?string'] );
            }, { "signature": "function(?string):?string" } ),
            url_maybe: __w( function (/*?string*/ value ) /*?string*/ {
               __t( [value, '?string', 'value'] ); return __t( [function () {
                  return value ? resolveURI( value ) : value;
               }.apply( this, arguments ), '?string'] );
            }, { "signature": "function(?string):?string" } ),
            hostname: __w( function (/*?string*/ value ) /*?string*/ {
               __t( [value, '?string', 'value'] ); return __t( [function () {
                  return value || window.location.hostname;
               }.apply( this, arguments ), '?string'] );
            }, { "signature": "function(?string):?string" } ),
            px: __w( function (/*?string*/ value ) /*?number*/ {
               __t( [value, '?string', 'value'] ); return __t( [function () {
                  return ( /^(\d+)(?:px)?$/ ).test( value ) ? parseInt( RegExp.$1, 10 ) : undefined;
               }.apply( this, arguments ), '?number'] );
            }, { "signature": "function(?string):?number" } ),
            text: __w( function (/*?string*/ value ) /*?string*/ {
               __t( [value, '?string', 'value'] ); return __t( [function () {
                  return value;
               }.apply( this, arguments ), '?string'] );
            }, { "signature": "function(?string):?string" } )
         ...
         function getVal(/*object*/ attr, /*string*/ key ) {
            __t( [attr, 'object', 'attr'], [key, 'string', 'key'] );
            var val =
              attr[key] ||
         ...
         function validate(/*object*/ defn, /*DOMElement*/ elem, /*object*/ attr,
             /*object*/ params ) {
            __t( [defn, 'object', 'defn'], [elem, 'DOMElement', 'elem'], [attr, 'object', 'attr'], [params, 'object', 'params'] );
         ...
         var IframePlugin = Type.extend( {
            constructor: __w( function (/*DOMElement*/ elem, /*string*/ ns, /*string*/ tag,
               ...
               this.subscribe( 'xd.resize.flow', ES5( __w( function (/*object*/ message ) {
                  __t( [message, 'object', 'message'] );
               ...
               this.subscribe( 'xd.resize', ES5( __w( function (/*object*/ message ) {
                  __t( [message, 'object', 'message'] );
                  this._config.root.style.verticalAlign = 'bottom';
                  resize( this._config.root, parse( message.width ), parse( message.height ) );
               ...
               this.subscribe( 'xd.resize.iframe', ES5( __w( function (/*object*/ message ) {
                  __t( [message, 'object', 'message'] );
                  resize( this._iframe, parse( message.width ), parse( message.height ) );
                  this.updateLift();
                  clearTimeout( this._timeoutID );
               ...
               this.subscribe( 'xd.sdk_event', __w( function (/*object*/ message ) {
                  __t( [message, 'object', 'message'] );
               ...
               var name = guid();
               this.subscribe( 'xd.verify', __w( function (/*object*/ msg ) {
                  __t( [msg, 'object', 'msg'] );
                  XD.sendToFacebook(
         ...
         IframePlugin.withParams = __w( function (/*object*/ params ) /*function*/ {
            __t( [params, 'object', 'params'] ); return __t( [function () {
      ...
      __d( "sdk.XFBML.Element", ["sdk.DOM", "Type", "ObservableMixin"], function ( global, require, requireDynamic, requireLazy, module, exports, DOM, Type, ObservableMixin ) {
         ...
         var Element = Type.extend( {
            ...
            constructor: __w( function (/*DOMElement*/ dom ) {
               __t( [dom, 'DOMElement', 'dom'] );
               this.parent();
               this.dom = dom;
            }, { "signature": "function(DOMElement)" } ),
            ...
            getAttribute: __w( function (/*string*/ name, defaultValue,
                /*?function*/ transform ) {
               __t( [name, 'string', 'name'], [transform, '?function', 'transform'] );
            ...
            _getBoolAttribute: __w( function (/*string*/ name, /*?boolean*/ defaultValue )
               /*?boolean*/ {
               __t( [name, 'string', 'name'], [defaultValue, '?boolean', 'defaultValue'] ); return __t( [function () {
                  var value = DOM.getBoolAttr( this.dom, name );
                  return value === null
                    ? defaultValue
                    : value;
               }.apply( this, arguments ), '?boolean'] );
            }, { "signature": "function(string,?boolean):?boolean" } ),


            _getPxAttribute: __w( function (/*string*/ name, /*?number*/ defaultValue )
               /*?number*/ {
               __t( [name, 'string', 'name'], [defaultValue, '?number', 'defaultValue'] ); return __t( [function () {
            ...
            }, { "signature": "function(string,?number):?number" } ),


            _getLengthAttribute: __w( function (/*string*/ name, /*?number*/ defaultValue ) {
               __t( [name, 'string', 'name'], [defaultValue, '?number', 'defaultValue'] );
               return this.getAttribute( name, defaultValue, __w( function (/*string*/ s ) {
                  __t( [s, 'string', 's'] );
                  if ( s === '100%' ) {
                     return s;
            ...
            _getAttributeFromList: __w( function (/*string*/ name, /*string*/ defaultValue,
                /*array<string>*/ allowed ) /*string*/ {
               __t( [name, 'string', 'name'], [defaultValue, 'string', 'defaultValue'], [allowed, 'array<string>', 'allowed'] ); return __t( [function () {
                  return this.getAttribute( name, defaultValue, __w( function (/*string*/ s )
                     /*string*/ {
                     __t( [s, 'string', 's'] ); return __t( [function () {
                        s = s.toLowerCase();
            ...
            }, { "signature": "function(string,string,array<string>):string" } ),


            isValid: __w( function () /*?boolean*/ {
               return __t( [function () {
      ...
      __d( "sdk.XFBML.IframeWidget", ["sdk.Arbiter", "sdk.Auth", "sdk.Content", "copyProperties", "sdk.DOM", "sdk.Event", "sdk.XFBML.Element", "guid", "insertIframe", "QueryString", "sdk.Runtime", "sdk.ui", "UrlMap", "sdk.XD"], function ( global, require, requireDynamic, requireLazy, module, exports, Arbiter, Auth, Content, copyProperties, DOM, Event, Element, guid, insertIframe, QueryString, Runtime, ui, UrlMap, XD ) {
         ...
         var IframeWidget = Element.extend( {
            ...
            getUrlBits: __w( function () /*object*/ {
               return __t( [function () {
            ...
            setupAndValidate: __w( function () /*boolean*/ {
               return __t( [function () {
                  return true;
               }.apply( this, arguments ), 'boolean'] );
            }, { "signature": "function():boolean" } ),
            ...
            getIframeName: __w( function () /*?string*/ {
               return __t( [function () {
            ...
            getIframeTitle: __w( function () /*?string*/ {
               return __t( [function () {
            ...
            getChannelUrl: __w( function () /*string*/ {
               return __t( [function () {
                  if ( !this._channelUrl ) {
            ...
            getIframeNode: __w( function () /*?DOMElement*/ {
               return __t( [function () {
            ...
            arbiterInform: __w( function (/*string*/ event, /*?object*/ message,
                /*?string*/ behavior ) {
               __t( [event, 'string', 'event'], [message, '?object', 'message'], [behavior, '?string', 'behavior'] );
               XD.sendToFacebook(
                 this.getIframeName(), {
                    method: event,
            ...
            process: __w( function (/*?boolean*/ force ) {
               __t( [force, '?boolean', 'force'] );
            ...
            generateWidgetPipeIframeName: __w( function () /*string*/ {
               return __t( [function () {
            ...
            getFullyQualifiedURL: __w( function () /*string*/ {
               return __t( [function () {
            ...
            _getWidgetPipeShell: __w( function () /*string*/ {
               return __t( [function () {
            ...
            _setupAuthRefresh: function () {
               Auth.getLoginStatus( ES5( __w( function (/*object*/ response ) {
                  __t( [response, 'object', 'response'] );
                  var lastStatus = response.status;
                  Event.subscribe( 'auth.statusChange', ES5( __w( function (/*object*/ response ) {
                     __t( [response, 'object', 'response'] );
                     if ( !this.isValid() ) {
                        return;
                     }
            ...
            _handleResizeMsg: __w( function (/*object*/ message ) {
               __t( [message, 'object', 'message'] );
               if ( !this.isValid() ) {
                  return;
               }
            ...
            _bubbleResizeEvent: __w( function (/*object*/ message ) {
               __t( [message, 'object', 'message'] );
            ...
            _resizeIframe: __w( function (/*object*/ message ) {
               __t( [message, 'object', 'message'] );
            ...
            _resizeFlow: __w( function (/*object*/ message ) {
               __t( [message, 'object', 'message'] );
            ...
            _repositionIframe: __w( function (/*object*/ message ) {
               __t( [message, 'object', 'message'] );
               var iframe = this.getIframeNode();
         ...
         function groupWidgetPipeDescriptions() /*object*/ {
            return __t( [function () {
         ...
         } __w( groupWidgetPipeDescriptions, { "signature": "function():object" } );
      ...
      __d( "sdk.XFBML.Comments", ["sdk.Event", "sdk.XFBML.IframeWidget", "QueryString", "sdk.Runtime", "JSSDKConfig", "UrlMap", "UserAgent"], function ( global, require, requireDynamic, requireLazy, module, exports, Event, IframeWidget, QueryString, Runtime, SDKConfig, UrlMap, UserAgent ) {
         ...
         var Comments = IframeWidget.extend( {
            ...
            _handleCommentMsg: __w( function (/*object*/ message ) {
               __t( [message, 'object', 'message'] );
            ...
            _handleCommentCreatedMsg: __w( function (/*object*/ message ) {
               __t( [message, 'object', 'message'] );
               if ( !this.isValid() ) {
                  return;
               }
            ...
            _handleCommentRemovedMsg: __w( function (/*object*/ message ) {
               __t( [message, 'object', 'message'] );
               if ( !this.isValid() ) {
                  return;
               }
      ...
      __d( "mergeArrays", [], function ( global, require, requireDynamic, requireLazy, module, exports ) {
         function mergeArrays(/*array*/ target, /*array*/ source ) /*array*/ {
            __t( [target, 'array', 'target'], [source, 'array', 'source'] ); return __t( [function () {
         ...
         } __w( mergeArrays, { "signature": "function(array,array):array" } );
      ...
      __d( "format", [], function ( global, require, requireDynamic, requireLazy, module, exports ) {
         ...
         } __w( format, { "signature": "function(string):string" } );
      ...
      __d( "safeEval", [], function ( global, require, requireDynamic, requireLazy, module, exports ) {
         function safeEval( source, /*?array*/ args ) {
            __t( [args, '?array', 'args'] );
      ...
      __d( "sdk.Waitable", ["sdk.Model"], function ( global, require, requireDynamic, requireLazy, module, exports, Model ) {
         ...
         var Waitable = Model.extend( {
            ...
            error: __w( function (/*Error*/ ex ) {
               __t( [ex, 'Error', 'ex'] );
               this.inform( "error", ex );
            }, { "signature": "function(Error)" } ),


            wait: __w( function (/*function?*/ callback, /*function?*/ errorHandler ) {
               __t( [callback, '?function', 'callback'], [errorHandler, '?function', 'errorHandler'] );

               if ( errorHandler ) {
                  this.subscribe( 'error', errorHandler );
               }

               this.monitor( 'Value.change', ES5( __w( function () /*boolean?*/ {
                  return __t( [function () {
               ...
               }, { "signature": "function():boolean?" } ), 'bind', true, this ) );
            }, { "signature": "function(?function,?function)" } )
         } );
      ...
      __d( "sdk.Query", ["format", "safeEval", "Type", "sdk.Waitable"], function ( global, require, requireDynamic, requireLazy, module, exports, format, safeEval, Type, Waitable ) {
         ...
         function toFields(/*string*/ s ) /*array<string>*/ {
            __t( [s, 'string', 's'] ); return __t( [function () {
               return ES5( s.split( ',' ), 'map', true, function ( s ) { return ES5( s, 'trim', true ); } );
            }.apply( this, arguments ), 'array<string>'] );
         } __w( toFields, { "signature": "function(string):array<string>" } );


         function parseWhere(/*string*/ s ) /*object*/ {
            __t( [s, 'string', 's'] ); return __t( [function () {
         ...
         } __w( parseWhere, { "signature": "function(string):object" } );
         ...
         } __w( encode, { "signature": "function():string" } );
         ...
         var Query = Waitable.extend( {
            ...
            hasDependency: __w( function (/*boolean?*/ value ) /*boolean*/ {
               __t( [value, '?boolean', 'value'] ); return __t( [function () {
                  if ( arguments.length ) {
                     this._hasDependency = value;
                  }
                  return !!this._hasDependency;
               }.apply( this, arguments ), 'boolean'] );
            }, { "signature": "function(?boolean):boolean" } ),


            parse: __w( function (/*array*/ args ) /*object*/ {
               __t( [args, 'array', 'args'] ); return __t( [function () {
                  var
      ...
      __d( "sdk.Data", ["sdk.api", "sdk.ErrorHandling", "mergeArrays", "sdk.Query", "safeEval", "sdk.Waitable"], function ( global, require, requireDynamic, requireLazy, module, exports, api, ErrorHandling, mergeArrays, Query, safeEval, Waitable ) {
         ...
         var Data = {
            ...
            query: __w( function (/*string*/ template, data ) /*object*/ {
               __t( [template, 'string', 'template'] ); return __t( [function () {
            ...
            waitOn: __w( function (/*array*/ dependencies, /*function*/ callback ) /*Waitable*/ {
               __t( [dependencies, 'array', 'dependencies'], [callback, 'function', 'callback'] ); return __t( [function () {
                  var
                    result = new Waitable(),
                  ...
                  ES5( dependencies, 'forEach', true, __w( function (/*object*/ item ) {
                     __t( [item, 'object', 'item'] );
                  ...
                  return result;
               }.apply( this, arguments ), 'Waitable'] );
            }, { "signature": "function(array,function):Waitable" } ),


            process: __w( function (/*?string*/ token ) {
               __t( [token, '?string', 'token'] );
               Data._process( token );
            }, { "signature": "function(?string)" } ),
            ...
            _selectByIndex: __w( function (/*array*/ fields, /*string*/ table, /*string*/ name,
                /*string*/ value ) /*object*/ {
               __t( [fields, 'array', 'fields'], [table, 'string', 'table'], [name, 'string', 'name'], [value, 'string', 'value'] ); return __t( [function () {
                  var query = new Query();
                  query.fields = fields;
                  query.table = table;
            ...
            }, { "signature": "function(array,string,string,string):object" } ),
            ...
            _process: __w( function (/*?string*/ token ) {
               __t( [token, '?string', 'token'] );
               Data.timer = -1;
               ...
               api( '/fql', 'GET', params, __w( function (/*object*/ result ) {
                  __t( [result, 'object', 'result'] );
                  if ( result.error ) {
                     ES5( ES5( 'Object', 'keys', false, mqueries ), 'forEach', true, __w( function (/*string*/ key ) {
                        __t( [key, 'string', 'key'] );
                        mqueries[key].error( new Error( result.error.message ) );
                     }, { "signature": "function(string)" } ) );
                  } else {
                     ES5( result.data, 'forEach', true, __w( function (/*object*/ o ) {
                        __t( [o, 'object', 'o'] );
            ...
            _mergeIndexQuery: __w( function (/*object*/ item, /*object*/ mqueries ) {
               __t( [item, 'object', 'item'], [mqueries, 'object', 'mqueries'] );
               ...
               master.wait( __w( function (/*array<object>*/ r ) {
                  __t( [r, 'array<object>', 'r'] );
                  item.setValue( ES5( r, 'filter', true, __w( function (/*object*/ x ) {
                     __t( [x, 'object', 'x'] );
                     return x[key] == value;
                  }, { "signature": "function(object)" } ) ) );
               }, { "signature": "function(array<object>)" } ) );
         ...
         var CommentsCount = Element.extend( {
            ...
            process: function () {
               ...
               Data._selectByIndex( ['commentsbox_count'], 'link_stat', 'url', href )
                 .wait( ES5( __w( function (/*array<object>*/ value ) {
                    __t( [value, 'array<object>', 'value'] );
      ...
      __d( "sdk.Anim", ["sdk.DOM"], function ( global, require, requireDynamic, requireLazy, module, exports, DOM ) {
         ...
         var Anim = {
            ...
            ate: __w( function (/*DOMElement*/ dom, /*object*/ props, /*number?*/ duration,
                /*function?*/ callback ) {
               __t( [dom, 'DOMElement', 'dom'], [props, 'object', 'props'], [duration, '?number', 'duration'], [callback, '?function', 'callback'] );
               ...
               var
                 ...
                 timer = setInterval( ES5( function () {
                    ...
                    for ( var prop in props ) if ( props.hasOwnProperty( prop ) ) {
                       ...
                       var next = '';
                       ES5( from[prop], 'forEach', true, __w( function (/*object*/ pair, /*number*/ i ) {
                          __t( [pair, 'object', 'pair'], [i, 'number', 'i'] );
            ...
            _parseCSS: __w( function (/*string*/ css ) /*array<object>*/ {
               __t( [css, 'string', 'css'] ); return __t( [function () {
                  var ret = [];
            ...
            }, { "signature": "function(string):array<object>" } )
         };
         module.exports = Anim;
      ...
      __d( "escapeHTML", [], function ( global, require, requireDynamic, requireLazy, module, exports ) {
         ...
         } __w( escapeHTML, { "signature": "function(string):string" } );
      ...
      __d( "sdk.Helper", ["sdk.ErrorHandling", "sdk.Event", "UrlMap", "safeEval", "sprintf"], function ( global, require, requireDynamic, requireLazy, module, exports, ErrorHandling, Event, UrlMap, safeEval, sprintf ) {
         ...
         var Helper = {
            ...
            isUser: __w( function ( id ) /*boolean*/ {
               return __t( [function () {
            ...
            upperCaseFirstChar: __w( function (/*string*/ s ) /*string*/ {
               __t( [s, 'string', 's'] ); return __t( [function () {
                  if ( s.length > 0 ) {
            ...
            getProfileLink: __w( function (
              ...
              /*?string*/ href
               ...
               __t( [userInfo, '?object', 'userInfo'], [html, 'string', 'html'], [href, '?string', 'href'] ); return __t( [function () {
                  if ( !href && userInfo ) {
                     href = sprintf(
                       '%s/profile.php?id=%s',
                       UrlMap.resolve( 'www' ),
            ...
            }, { "signature": "function(?object,string,?string):string" } ),


            invokeHandler: __w( function ( handler, /*?object*/ scope, /*?array*/ args ) {
               __t( [scope, '?object', 'scope'], [args, '?array', 'args'] );
               if ( handler ) {
            ...
            fireEvent: __w( function (/*string*/ eventName, /*object*/ eventSource ) {
               __t( [eventName, 'string', 'eventName'], [eventSource, 'object', 'eventSource'] );
            ...
            executeFunctionByName: __w( function (/*string*/ functionName /*, args */ ) {
               __t( [functionName, 'string', 'functionName'] );
               var args = Array.prototype.slice.call( arguments, 1 );
      ...
      __d( "sdk.XFBML.ConnectBar", ["sdk.Anim", "sdk.api", "sdk.Auth", "createArrayFrom", "JSSDKConnectBarConfig", "sdk.Data", "sdk.DOM", "sdk.XFBML.Element", "escapeHTML", "sdk.Event", "format", "sdk.Helper", "sdk.Insights", "sdk.Intl", "sdk.Runtime", "UrlMap", "UserAgent"], function ( global, require, requireDynamic, requireLazy, module, exports, Anim, api, Auth, createArrayFrom, ConnectBarConfig, Data, DOM, Element, escapeHTML, Event, format, Helper, Insights, Intl, Runtime, UrlMap, UserAgent ) {
         ...
         var ConnectBar = Element.extend( {
            ...
            process: function () {
               ...
               Auth.getLoginStatus( ES5( __w( function (/*object*/ resp ) {
                  __t( [resp, 'object', 'resp'] );
                  Event.monitor( 'auth.statusChange', ES5( __w( function () /*boolean*/ {
                     return __t( [function () {
            ...
            _showBar: function () {
               ...
               var q2 = Data._selectByIndex( ['display_name'], 'application',
                                               'api_key', Runtime.getClientID() );
               Data.waitOn( [q1, q2], ES5( __w( function (/*array<array<object>>*/ data ) {
                  __t( [data, 'array<array<object>>', 'data'] );
            ...
            _renderConnectBar: __w( function (/*object*/ info ) {
               __t( [info, 'object', 'info'] );
               ...
               ES5( createArrayFrom( bar.getElementsByTagName( 'a' ) ), 'forEach', true, __w( function (/*DOMElement*/ el ) {
                  __t( [el, 'DOMElement', 'el'] );
            ...
            _closeConnectBar: function () {
               ...
               }, speed, __w( function (/*DOMElement*/ el ) {
                  __t( [el, 'DOMElement', 'el'] );
      ...
      __d( "sdk.XFBML.LoginButton", ["sdk.Helper", "IframePlugin"], function ( global, require, requireDynamic, requireLazy, module, exports, Helper, IframePlugin ) {
         ...
         var LoginButton = IframePlugin.extend( {
            constructor: __w( function (/*DOMElement*/ elem, /*string*/ ns, /*string*/ tag,
               ...
               if ( onlogin ) {
                  this.subscribe( 'login.status', __w( function (/*object*/ response ) {
                     __t( [response, 'object', 'response'] );
         ...
         var Name = Element.extend( {
            ...
            process: function () {
               ...
               Event.monitor( 'auth.statusChange', ES5( function () {
                  ...
                  data.wait( ES5( __w( function (/*array<object>*/ data ) {
                     __t( [data, 'array<object>', 'data'] );
            ...
            _renderPronoun: __w( function (/*object*/ userInfo ) {
               __t( [userInfo, 'object', 'userInfo'] );
               var
                 word = '',
            ...
            _renderOther: __w( function (/*object*/ userInfo ) {
               __t( [userInfo, 'object', 'userInfo'] );
               var
                 name = '',
                 html = '';
      ...
      __d( "sdk.XFBML.RecommendationsBar", ["sdk.Arbiter", "DOMEventListener", "sdk.Event", "sdk.XFBML.IframeWidget", "resolveURI", "sdk.Runtime"], function ( global, require, requireDynamic, requireLazy, module, exports, Arbiter, DOMEventListener, Event, IframeWidget, resolveURI, Runtime ) {
         ...
         var Bar = IframeWidget.extend( {
            ...
            setupAndValidate: __w( function () /*boolean*/ {
               return __t( [function () {
                  ...
                  function interval_queue(/*number*/ interval, /*function*/ func )
                     /*function*/ {
                     __t( [interval, 'number', 'interval'], [func, 'function', 'func'] ); return __t( [function () {
                        var last_run = 0;
                        var queued = null;
                  ...
                  } __w( interval_queue, { "signature": "function(number,function):function" } );

                  function validate_trigger(/*string?*/ trigger ) {
                     __t( [trigger, '?string', 'trigger'] );
                  ...
                  function validate_read_time(/*string?*/ read_time ) /*number*/ {
                     __t( [read_time, '?string', 'read_time'] ); return __t( [function () {
                        return Math.max( parseInt( read_time, 10 ) || 30, 10 );
                     }.apply( this, arguments ), 'number'] );
                  } __w( validate_read_time, { "signature": "function(?string):number" } );

                  function validate_side(/*string?*/ side ) /*string*/ {
                     __t( [side, '?string', 'side'] ); return __t( [function () {
                        if ( side == 'left' || side == 'right' ) {
                           return side;
                        }
                        return Runtime.getRtl() ? 'left' : 'right';
                     }.apply( this, arguments ), 'string'] );
                  } __w( validate_side, { "signature": "function(?string):string" } );
                  ...
                  if ( this._attr.trigger == "manual" ) {
                     var manual = ES5( __w( function (/*string*/ href ) /*boolean*/ {
                        __t( [href, 'string', 'href'] ); return __t( [function () {
                     ...
                     }, { "signature": "function(string):boolean" } ), 'bind', true, this );
                  ...
                  this.focused = true;
                  var toggleFocused = ES5( __w( function () /*boolean*/ {
                     return __t( [function () {
            ...
            calculateVisibility: __w( function () /*boolean*/ {
               return __t( [function () {
      ...
      __d( "sdk.XFBML.Registration", ["sdk.Auth", "sdk.Helper", "sdk.XFBML.IframeWidget", "sdk.Runtime", "UrlMap"], function ( global, require, requireDynamic, requireLazy, module, exports, Auth, Helper, IframeWidget, Runtime, UrlMap ) {
         ...
         var Registration = IframeWidget.extend( {
            ...
            setupAndValidate: __w( function () /*boolean*/ {
               return __t( [function () {
                  ...
                  if ( this._attr.onvalidate ) {
                     this.subscribe( 'xd.validate', ES5( __w( function (/*object*/ message ) {
                        __t( [message, 'object', 'message'] );
            ...
            _getHeight: __w( function () /*number*/ {
               return __t( [function () {
      ...
      __d( "sdk.XFBML.SocialContext", ["sdk.Event", "sdk.XFBML.IframeWidget"], function ( global, require, requireDynamic, requireLazy, module, exports, Event, IframeWidget ) {
         ...
         var SocialContext = IframeWidget.extend( {
            ...
            _bubbleSocialContextStats: __w( function (/*object*/ message ) {
               __t( [message, 'object', 'message'] );
               var filtered_message = {
                  pluginID: this.getAttribute( 'plugin-id' ),
      ...
      __d( "legacy:fb.versioned-sdk", ["sdk.Runtime"], function ( global, require, requireDynamic, requireLazy, __DO_NOT_USE__module, __DO_NOT_USE__exports, Runtime ) {
...
} catch ( e ) { new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent( '{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + ( e.lineNumber || e.line ) + '","script":"' + ( e.fileName || e.sourceURL || e.script ) + '","stack":"' + ( e.stackTrace || e.stack ) + '","revision":"1286616","message":"' + e.message + '"}}' ); }