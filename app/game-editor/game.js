define(['durandal/app', 'durandal/system', 'api/datacontext', 'api/constants', 'api/model/Path'],
  function (app, system, ctx, consts, Path) {
    ...
    var createTile = function () {
      ...
      tile.addPath = function (t, el, nWords) {
        var existingPaths = ko.utils.arrayFirst(ctx.paths(), function (p) {
        ...
        var path = new Path(ctx, lastPathID++, nWords == undefined ? 3 : nWords,
          startTile.id, endTile.id, existingPaths == null ? true : !existingPaths.cw);
