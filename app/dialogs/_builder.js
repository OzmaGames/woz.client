define(['durandal/system', 'durandal/app', 'durandal/composition', 'durandal/activator', 'knockout', 'jquery'],
  function (system, app, composition, activator, ko, $) {

      var className = 'dialogs';
      var dialogs = {};
      var _resolved = $.Deferred(function (dfd) { dfd.resolve() }).promise();
      ...
      function ensureInstance(objOrModuleId) {
          return system.defer(function (dfd) {
              if (system.isString(objOrModuleId)) {
                  require([objOrModuleId], function (module) {
