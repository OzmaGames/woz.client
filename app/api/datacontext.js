define(['durandal/system', 'durandal/app', 'api/constants', 'dialogs/_constants', 'api/model/Path'],
  function (system, app, consts, DIALOGS, Path) {
     ...
     app.on('account:login', function (res) {
        if (res.success) model.username = res.username;
     });
