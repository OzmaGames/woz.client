///#source 1 1 /lib/jquery/jquery.js
/*!
...
///#source 1 1 /lib/knockout/knockout.js
...
_html2canvas.Parse = function (images, options) {
  ...
  function setTextVariables(ctx, el, text_decoration, color, shadow) {
     var align = false,
  ...
  function renderText(el, textNode, stack) {
    ...
    if (Util.trimText(textNode.nodeValue).length > 0) {
      ...
      do {
         metrics = setTextVariables( ctx, el, textDecoration, color, shadows.pop() );

         textList.forEach( function ( text, index ) {            
            var bounds;
            bounds = cache[index] || getTextBounds( state, text, textDecoration, ( index < textList.length - 1 ), stack.transform.matrix );
            cache[index] = bounds;
            if ( bounds ) {               
...
///#source 1 1 /lib/toastr/toastr.js
/*
 * Toastr
